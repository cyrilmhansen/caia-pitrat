...
(*f[1494])( );     /*EXPVAUT0(BA,jvj+1,jvj+8)*/
...
(*f[1494])( );     /*EXPVAUT0(BA,jvj+3,jvj+9)*/
...
(*f[2117])( );if(v[102]) goto l2;     /*POSNEXPR0(jvj+1,BA,jvj+2)*/
...
(*f[2117])( );if(v[102]) goto l2;     /*POSNEXPR0(jvj+3,BA,jvj+4)*/
