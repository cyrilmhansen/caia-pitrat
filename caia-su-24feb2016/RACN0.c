...
(*f[1007])( );if(v[102]) goto l18;     /*POWER0(V3,X,H)*/
H=pile[WZ2]; 
V2=B*H;
if((V2<=0)) goto l18;
V8=H*X;
...
(*f[1007])( );if(v[102]) goto l21;     /*POWER0(B,Y,P)*/
P=pile[WZ2]; 
...
(*f[1007])( );if(v[102]) goto l26;     /*POWER0(B,V17,V15)*/
V15=pile[WZ2]; 
if((A>=V15)) goto l26;
R=V16;
goto l28;
...
(*f[1358])( );if(v[102]) goto l27;     /*RACN1(Y,A,B,C,V12,R)*/
R=pile[WZ5]; 
goto l28;
l23:if((P==A)) goto l24;
if((A<=P)) goto l26;
