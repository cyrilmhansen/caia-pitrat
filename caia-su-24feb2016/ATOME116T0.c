...
(*f[1950])( );if(v[102]) goto l3;     /*FNDOND0(498,jvj+8,jvj+9)*/
...
pile[v[22]]=jvj+15; pile[WZ1]=3544; pile[WZ2]=246; pile[WZ3]=jvj+16; 
(*f[189])( );     /*TRI4(jvj+15,3544,246,jvj+16)*/
...
(*f[2058])( );     /*VAUT0(jvj+13,164,jvj+12,V1)*/
