...
(*f[1977])( );if(v[102]) goto l3;     /*FNDCND0(280,V,I)*/
I=pile[WZ2]; 
pile[v[22]]=164; 
(*f[1977])( );if(v[102]) goto l3;     /*FNDCND0(164,V,J)*/
J=pile[WZ2]; 
...
pile[v[22]]=jvj+11; pile[WZ1]=3941; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3941,246,jvj+12)*/
...
(*f[1571])( );     /*DELIER0(365,V,jvj+8,jvj+9)*/
goto l2;
}
