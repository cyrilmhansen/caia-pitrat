...
(*f[1806])( );     /*SPE0(V198,jvj+10,32,21,V199)*/
V199=pile[WZ4]; 
pile[v[22]]=V199; 
(*f[1805])( );     /*SPLL0(V199,M)*/
M=pile[WZ1]; 
...
V174=pile[WZ2]; 
pile[v[22]]=V174; 
(*f[1810])( );if(v[102]) goto l19;     /*SPKM0(V174,V175)*/
V175=pile[WZ1]; 
...
(*f[1806])( );     /*SPE0(V25,jvj+3,32,255,V26)*/
V26=pile[WZ4]; 
pile[v[22]]=V26; 
(*f[1805])( );     /*SPLL0(V26,V)*/
V=pile[WZ1]; 
...
(*f[1806])( );     /*SPE0(V184,jvj+5,32,21,V185)*/
V185=pile[WZ4]; 
pile[v[22]]=V185; 
(*f[1805])( );     /*SPLL0(V185,G)*/
G=pile[WZ1]; 
...
(*f[1806])( );     /*SPE0(V191,jvj+7,32,21,V192)*/
V192=pile[WZ4]; 
pile[v[22]]=V192; 
(*f[1805])( );     /*SPLL0(V192,K)*/
K=pile[WZ1]; 
