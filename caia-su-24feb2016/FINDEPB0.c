...
(*f[1284])( );     /*ANAPRED1(735,jvj+6,B,68,jvj+7)*/
...
(*f[1286])( );if(v[102]) goto l10;     /*ECRIREJOURNAL0(B,jvj+13)*/
...
(*f[1290])( );if(v[102]) goto l13;     /*CALDIFF0(D)*/
D=pile[v[22]]; 
...
(*f[1283])( );     /*ANAPRED0(jvj+20,jvj+22,B,68,jvj+13)*/
x[jvj+44]=t[x[jvj+44]];
goto l17;
l19:
(*f[170])( );     /*SURVEILLE0()*/
...
(*f[1289])( );     /*SQUELETTE0(jvj+24,jvj+23)*/
