...
(*f[3132])( );if(v[102]) goto l3;     /*SUBSTITUVAR1(RX,jvj+3,jvj+12,jvj+13,jvj+14)*/
...
pile[v[22]]=jvj+17; pile[WZ1]=3396; pile[WZ2]=246; pile[WZ3]=jvj+18; 
(*f[189])( );     /*TRI4(jvj+17,3396,246,jvj+18)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+13,jvj+15)*/
goto l3;
}
