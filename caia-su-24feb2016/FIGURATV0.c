...
(*f[1135])( );     /*FIGURATV0(jvj+7,A,V,jvj+8)*/
...
(*f[1135])( );     /*FIGURATV0(jvj+10,A,V,jvj+11)*/
...
(*f[1135])( );     /*FIGURATV0(jvj+14,A,V,jvj+15)*/
...
(*f[1135])( );     /*FIGURATV0(jvj+19,A,V,jvj+20)*/
...
(*f[1135])( );     /*FIGURATV0(jvj+24,A,V,jvj+25)*/
