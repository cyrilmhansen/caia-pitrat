...
(*f[1971])( );     /*FNDEND0(365,jvj+3,jvj+8)*/
...
(*f[1740])( );if(v[102]) goto l7;     /*EVLM0(R,jvj+3,jvj+9,V1)*/
V1=pile[WZ3]; 
if((V1!=134)) goto l7;
...
pile[v[22]]=jvj+12; pile[WZ1]=3325; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3325,246,jvj+13)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+3,jvj+9,jvj+10)*/
l7:x[jvj+17]=t[x[jvj+17]];
goto l5;
l1:pile[v[22]]=498; pile[WZ1]=jvj+3; pile[WZ2]=jvj+4; 
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,jvj+3,jvj+4)*/
pile[v[22]]=472; pile[WZ1]=jvj+4; 
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(472,jvj+4,V6)*/
V6=pile[WZ2]; 
if((V6==1)) goto l6;
