...
(*f[2088])( );     /*ORA0(jvj+23,R,jvj+23,jvj+24)*/
x[jvj+80]=t[x[jvj+80]];
goto l19;
...
(*f[2089])( );     /*ORI0(R,jvj+27,VB,VA,jvj+30)*/
goto l25;
...
(*f[1654])( );     /*ORB0(jvj+67,jvj+68,jvj+64)*/
