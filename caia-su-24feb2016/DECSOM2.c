...
(*f[1669])( );     /*DECOMP0(jvj+7,jvj+8,jvj+9,N)*/
N=pile[WZ3]; 
...
(*f[1670])( );     /*DECSOM1(jvj+12,E,jvj+8)*/
pile[v[22]]=jvj+13; 
(*f[1670])( );     /*DECSOM1(jvj+13,E,jvj+8)*/
...
(*f[1669])( );     /*DECOMP0(R,jvj+8,jvj+14,V8)*/
V8=pile[WZ3]; 
...
(*f[1026])( );if(v[102]) goto l9;     /*POSOM0(V28,V29,V30)*/
V30=pile[WZ2]; 
