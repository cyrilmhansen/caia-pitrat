...
(*f[1950])( );if(v[102]) goto l3;     /*FNDOND0(498,D,jvj+3)*/
...
pile[v[22]]=jvj+9; pile[WZ1]=3307; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3307,246,jvj+10)*/
...
(*f[1755])( );     /*LIER1(jvj+6,489,D,jvj+7)*/
goto l3;
}
