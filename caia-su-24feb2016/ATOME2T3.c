...
(*f[3038])( );if(v[102]) goto l1;     /*VALENS0(jvj+4,jvj+5)*/
...
pile[v[22]]=jvj+8; pile[WZ1]=3969; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3969,246,jvj+9)*/
...
(*f[3039])( );     /*AJOUNOEUD0(jvj+6,481,N,jvj+5)*/
