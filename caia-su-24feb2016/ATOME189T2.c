...
(*f[1977])( );if(v[102]) goto l12;     /*FNDCND0(929,RR,V8)*/
V8=pile[WZ2]; 
...
pile[v[22]]=jvj+22; pile[WZ1]=3408; pile[WZ2]=246; pile[WZ3]=jvj+23; 
(*f[189])( );     /*TRI4(jvj+22,3408,246,jvj+23)*/
...
(*f[1977])( );if(v[102]) goto l10;     /*FNDCND0(929,jvj+3,V7)*/
V7=pile[WZ2]; 
if((V7>=V8)) goto l10;
