...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,D,jvj+4)*/
...
(*f[1977])( );if(v[102]) goto l2;     /*FNDCND0(473,jvj+4,V4)*/
V4=pile[WZ2]; 
if((V2!=V4)) goto l2;
...
pile[v[22]]=jvj+8; pile[WZ1]=3072; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3072,246,jvj+9)*/
