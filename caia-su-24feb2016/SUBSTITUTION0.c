...
(*f[1293])( );if(v[102]) goto l1;     /*CONVEXP0(Y,jvj+2)*/
...
(*f[1292])( );if(v[102]) goto l3;     /*DEPEXP0(X,jvj+4)*/
...
(*f[1780])( );     /*SUBSTITUTION1(jvj+8,S,jvj+7,jvj+4,jvj+2)*/
...
(*f[1780])( );     /*SUBSTITUTION1(jvj+11,S,jvj+9,jvj+4,jvj+2)*/
x[jvj+14]=t[x[jvj+14]];
goto l12;
}
