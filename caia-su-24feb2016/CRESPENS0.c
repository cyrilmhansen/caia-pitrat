...
(*f[1292])( );if(v[102]) goto l3;     /*DEPEXP0(jvj+4,jvj+5)*/
...
(*f[3721])( );if(v[102]) goto l3;     /*CPTOCCURVAR0(A,V5,jvj+8,NK)*/
NK=pile[WZ3]; 
...
(*f[4011])( );if(v[102]) goto l14;     /*FACTELT0(jvj+23,P,MM,jvj+24)*/
...
(*f[4011])( );if(v[102]) goto l18;     /*FACTELT0(jvj+28,P,MM,jvj+29)*/
