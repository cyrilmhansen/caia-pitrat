...
(*f[1716])( );if(v[102]) goto l1;     /*BOOTRADB0(A,B,C,jvj+3)*/
...
(*f[1505])( );if(v[102]) goto l10;     /*BOOTRADA0(jvj+12,B,jvj+11,jvj+13)*/
...
(*f[1505])( );if(v[102]) goto l15;     /*BOOTRADA0(C,B,jvj+16,jvj+17)*/
