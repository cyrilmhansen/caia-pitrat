...
(*f[1950])( );if(v[102]) goto l16;     /*FNDOND0(202,D,jvj+18)*/
...
(*f[1292])( );if(v[102]) goto l17;     /*DEPEXP0(D,jvj+15)*/
V28=x[jvj+10];
...
pile[v[22]]=jvj+22; pile[WZ1]=3502; pile[WZ2]=246; pile[WZ3]=jvj+23; 
(*f[189])( );     /*TRI4(jvj+22,3502,246,jvj+23)*/
...
(*f[3503])( );     /*AFP1(jvj+16,jvj+15,I,jvj+14)*/
V28=t[V28];
goto l15;
...
(*f[1008])( );if(v[102]) goto l3;     /*DECFACTPREM0(V11,jvj+4)*/
...
pile[v[22]]=jvj+28; pile[WZ1]=3502; pile[WZ2]=246; pile[WZ3]=jvj+29; 
(*f[189])( );     /*TRI4(jvj+28,3502,246,jvj+29)*/
...
(*f[3504])( );     /*VENS0(jvj+20,1287,D,jvj+10)*/
