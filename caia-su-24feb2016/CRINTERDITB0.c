...
(*f[2057])( );     /*CRINTERDITB0(MIN,V25,jvj+2,jvj+3,S)*/
...
(*f[2057])( );     /*CRINTERDITB0(V16,V25,S,67,B)*/
...
(*f[2057])( );     /*CRINTERDITB0(MIN,V25,S,67,B)*/
...
(*f[2057])( );     /*CRINTERDITB0(MIN,V25,jvj+4,jvj+3,B)*/
