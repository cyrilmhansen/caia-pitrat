...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(498,jvj+8,jvj+10)*/
...
(*f[1977])( );if(v[102]) goto l5;     /*FNDCND0(280,jvj+13,V11)*/
V11=pile[WZ2]; 
if((V11<0)) goto l5;
...
pile[v[22]]=jvj+21; pile[WZ1]=3518; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3518,246,jvj+22)*/
