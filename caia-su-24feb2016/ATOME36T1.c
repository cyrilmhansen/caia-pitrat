...
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(473,N,V3)*/
V3=pile[WZ2]; 
...
pile[v[22]]=jvj+11; pile[WZ1]=3072; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3072,246,jvj+12)*/
...
(*f[1755])( );     /*LIER1(jvj+8,489,D,jvj+9)*/
