...
pile[v[22]]=473; 
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(473,N,V9)*/
V9=pile[WZ2]; 
pile[v[22]]=472; 
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(472,N,V10)*/
V10=pile[WZ2]; 
if((V9!=V10)) goto l4;
...
pile[v[22]]=jvj+13; pile[WZ1]=3436; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3436,246,jvj+14)*/
