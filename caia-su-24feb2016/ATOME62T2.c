...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,jvj+17,jvj+18)*/
pile[v[22]]=688; pile[WZ1]=jvj+18; 
(*f[1977])( );if(v[102]) goto l2;     /*FNDCND0(688,jvj+18,V8)*/
V8=pile[WZ2]; 
if((V8!=1)) goto l2;
...
pile[v[22]]=jvj+32; pile[WZ1]=3262; pile[WZ2]=246; pile[WZ3]=jvj+33; 
(*f[189])( );     /*TRI4(jvj+32,3262,246,jvj+33)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+30,jvj+29)*/
goto l9;
}
