...
(*f[1396])( );     /*ENTRE0(jvj+26,jvj+27,N,jvj+28)*/
N=pile[WZ2]; 
goto l19;
l21:V49=V51;
l22:x[jvj+45]=incon;
...
(*f[1397])( );     /*CONSTRUIT0(Y,I,KK,jvj+29,jvj+30,jvj+28,K,V,J,L,jvj+31,68)*/
goto l55;
