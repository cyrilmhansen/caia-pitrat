...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(202,jvj+5,jvj+6)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3789; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3789,246,jvj+12)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+5,jvj+9,jvj+8)*/
goto l4;
}
