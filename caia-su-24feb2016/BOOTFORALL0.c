...
(*f[1505])( );if(v[102]) goto l2;     /*BOOTRADA0(C,BA,jvj+10,jvj+11)*/
...
(*f[1505])( );if(v[102]) goto l2;     /*BOOTRADA0(C,BA,jvj+13,jvj+14)*/
...
(*f[2046])( );     /*BOOTFORALL1(jvj+6,RT,BA,jvj+9,C)*/
...
(*f[1505])( );if(v[102]) goto l5;     /*BOOTRADA0(C,BA,jvj+17,jvj+18)*/
