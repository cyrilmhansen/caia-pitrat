...
(*f[1382])( );     /*RECZ0(135,VC,CS)*/
pile[WZ1]=CA; pile[WZ2]=B; 
(*f[1382])( );     /*RECZ0(135,CA,B)*/
...
(*f[1428])( );     /*DMP0(jvj+20,jvj+21,jvj+17,102,jvj+20)*/
goto l12;
...
(*f[1428])( );     /*DMP0(jvj+27,jvj+28,jvj+24,102,jvj+27)*/
goto l12;
