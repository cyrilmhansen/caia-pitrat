...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,jvj+4,jvj+5)*/
...
(*f[3110])( );if(v[102]) goto l4;     /*SUPG0(DX,X,jvj+9)*/
...
(*f[3111])( );if(v[102]) goto l3;     /*INFG0(DX,jvj+14,jvj+15)*/
...
pile[v[22]]=jvj+19; pile[WZ1]=3109; pile[WZ2]=246; pile[WZ3]=jvj+20; 
(*f[189])( );     /*TRI4(jvj+19,3109,246,jvj+20)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+17,jvj+16)*/
