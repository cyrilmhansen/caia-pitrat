...
(*f[1977])( );if(v[102]) goto l2;     /*FNDCND0(929,jvj+2,V58)*/
V58=pile[WZ2]; 
...
pile[v[22]]=jvj+44; pile[WZ1]=3927; pile[WZ2]=246; pile[WZ3]=jvj+45; 
(*f[189])( );     /*TRI4(jvj+44,3927,246,jvj+45)*/
