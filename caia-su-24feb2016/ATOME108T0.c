...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(498,jvj+8,jvj+9)*/
...
(*f[1977])( );if(v[102]) goto l8;     /*FNDCND0(164,D,V2)*/
V2=pile[WZ2]; 
pile[v[22]]=280; 
(*f[1977])( );if(v[102]) goto l8;     /*FNDCND0(280,D,V3)*/
V3=pile[WZ2]; 
V1=V2-V3;
if((V1>=300)) goto l8;
pile[v[22]]=202; pile[WZ2]=jvj+2; 
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(202,D,jvj+2)*/
if((x[jvj+2]==68)) goto l8;
l4:if((v[225]<=0)) goto l5;
pile[v[22]]=929; pile[WZ1]=jvj+5; 
(*f[1977])( );if(v[102]) goto l5;     /*FNDCND0(929,jvj+5,V20)*/
V20=pile[WZ2]; 
V36=x[D];
...
(*f[1950])( );if(v[102]) goto l9;     /*FNDOND0(498,D,jvj+6)*/
l6:if((V3>V2)) goto l9;
pile[v[22]]=jvj+6; pile[WZ1]=V3; pile[WZ2]=jvj+3; 
(*f[1767])( );     /*AJARR0(jvj+6,V3,jvj+3)*/
...
pile[v[22]]=jvj+13; pile[WZ1]=3482; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3482,246,jvj+14)*/
...
(*f[1755])( );     /*LIER1(jvj+7,365,D,jvj+3)*/
V13=g[617];
if((V13<=0)) goto l7;
V14=vg[617];
if((V14!=0)) goto l1;
...
pile[v[22]]=jvj+19; pile[WZ1]=3482; pile[WZ2]=246; pile[WZ3]=jvj+20; 
(*f[189])( );     /*TRI4(jvj+19,3482,246,jvj+20)*/
