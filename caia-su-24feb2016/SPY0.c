...
(*f[2083])( );     /*SPJ0(V129,jvj+10,10429,V130)*/
V130=pile[WZ3]; 
...
(*f[2083])( );     /*SPJ0(V169,jvj+23,10429,V170)*/
V170=pile[WZ3]; 
...
(*f[2083])( );     /*SPJ0(V149,jvj+10,10429,V150)*/
V150=pile[WZ3]; 
