...
(*f[1678])( );if(v[102]) goto l15;     /*TRINOMERIG0(X,jvj+2,jvj+3,jvj+4,jvj+5)*/
...
(*f[1678])( );if(v[102]) goto l15;     /*TRINOMERIG0(Y,jvj+6,jvj+7,jvj+8,jvj+9)*/
...
(*f[1007])( );if(v[102]) goto l39;     /*POWER0(V159,V160,V161)*/
V161=pile[WZ2]; 
