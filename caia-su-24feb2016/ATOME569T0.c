...
{int V8=0,V7=0,V15=0,V17=0,V26=0,V27=0;
int V;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
jvj=v[0];
...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(202,V,jvj+6)*/
if((x[jvj+6]!=68)) goto l4;
pile[v[22]]=365; pile[WZ2]=jvj+7; 
(*f[1971])( );     /*FNDEND0(365,V,jvj+7)*/
...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,jvj+8,jvj+9)*/
...
pile[v[22]]=jvj+15; pile[WZ1]=3950; pile[WZ2]=246; pile[WZ3]=jvj+16; 
(*f[189])( );     /*TRI4(jvj+15,3950,246,jvj+16)*/
