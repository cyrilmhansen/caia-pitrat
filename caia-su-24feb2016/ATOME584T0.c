...
(*f[1950])( );if(v[102]) goto l5;     /*FNDOND0(498,jvj+15,jvj+2)*/
...
pile[v[22]]=jvj+22; pile[WZ1]=3967; pile[WZ2]=246; pile[WZ3]=jvj+23; 
(*f[189])( );     /*TRI4(jvj+22,3967,246,jvj+23)*/
...
(*f[2058])( );     /*VAUT0(jvj+19,280,jvj+20,V20)*/
x[jvj+18]=t[x[jvj+18]];
goto l4;
