...
(*f[1820])( );     /*COPV0(RM,107,Y,RM,jvj+10)*/
x[RES]=67 ;z[RES]=67;
...
(*f[2203])( );     /*COPWSP0(RM,jvj+30,V43,jvj+27,V65,Y)*/
goto l23;
...
(*f[1820])( );     /*COPV0(RM,107,Y,RM,jvj+60)*/
x[RES]=67 ;z[RES]=67;
goto l23;
...
(*f[1820])( );     /*COPV0(RM,107,Y,RM,jvj+53)*/
x[RES]=67 ;z[RES]=67;
