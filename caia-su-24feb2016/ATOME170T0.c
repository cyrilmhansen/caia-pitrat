...
(*f[1008])( );if(v[102]) goto l7;     /*DECFACTPREM0(V28,jvj+8)*/
...
(*f[1008])( );if(v[102]) goto l4;     /*DECFACTPREM0(I,jvj+17)*/
...
pile[v[22]]=jvj+23; pile[WZ1]=3554; pile[WZ2]=246; pile[WZ3]=jvj+24; 
(*f[189])( );     /*TRI4(jvj+23,3554,246,jvj+24)*/
