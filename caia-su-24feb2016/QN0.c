...
(*f[1983])( );if(v[102]) goto l12;     /*SPSS0(V68,jvj+9,V86)*/
V86=pile[WZ2]; 
...
(*f[1983])( );if(v[102]) goto l12;     /*SPSS0(V94,jvj+9,V95)*/
V95=pile[WZ2]; 
