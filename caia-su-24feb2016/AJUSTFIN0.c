...
(*f[1500])( );     /*CALCULABLE0(A,BA,XP,XD,jvj+2)*/
if((x[jvj+2]==67)) goto l2;
if((x[jvj+2]!=68)) goto l4;
pile[WZ3]=250; pile[WZ4]=jvj+3; 
(*f[1918])( );if(v[102]) goto l4;     /*AJUSTECAL2(A,BA,XP,250,jvj+3)*/
pile[v[22]]=jvj+3; pile[WZ2]=jvj+5; 
(*f[1919])( );     /*CREXPR0(jvj+3,BA,jvj+5)*/
x[jvj+8]=incon;
...
(*f[1501])( );if(v[102]) goto l4;     /*AJUSTEXP0(A,BA,XP,XD,R)*/
goto l5;
