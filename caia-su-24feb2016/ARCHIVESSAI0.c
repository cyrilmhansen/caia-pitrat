...
(*f[1145])( );     /*MEMEPB0(jvj+15,jvj+13,jvj+16)*/
...
(*f[1543])( );if(v[102]) goto l32;     /*CALRES0(B,jvj+33)*/
pile[WZ1]=jvj+8; pile[WZ2]=jvj+33; 
(*f[1544])( );     /*MEMORESSAI0(B,jvj+8,jvj+33)*/
goto l32;
l34:pile[v[22]]=90; 
(*f[1489])( );     /*SORES1(90)*/
V61=vv[20];
...
(*f[1290])( );if(v[102]) goto l50;     /*CALDIFF0(D)*/
D=pile[v[22]]; 
