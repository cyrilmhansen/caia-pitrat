...
pile[v[22]]=jvj+40; pile[WZ1]=3219; pile[WZ2]=246; pile[WZ3]=jvj+41; 
(*f[189])( );     /*TRI4(jvj+40,3219,246,jvj+41)*/
...
(*f[1740])( );if(v[102]) goto l8;     /*EVLM0(jvj+3,D,jvj+4,V1)*/
V1=pile[WZ3]; 
if((V1!=135)) goto l8;
x[jvj+44]=t[x[jvj+44]];
goto l2;
