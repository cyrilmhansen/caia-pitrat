...
(*f[1355])( );     /*POSOUNUL0(jvj+17,jvj+18)*/
...
(*f[1977])( );if(v[102]) goto l5;     /*FNDCND0(929,jvj+2,V27)*/
V27=pile[WZ2]; 
...
pile[v[22]]=jvj+44; pile[WZ1]=3870; pile[WZ2]=246; pile[WZ3]=jvj+45; 
(*f[189])( );     /*TRI4(jvj+44,3870,246,jvj+45)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+3,jvj+20)*/
goto l2;
