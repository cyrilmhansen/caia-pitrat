...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,jvj+6,jvj+7)*/
...
(*f[3890])( );if(v[102]) goto l3;     /*SUPB0(jvj+11,jvj+12)*/
...
(*f[1721])( );     /*SUBSTITUTES0(jvj+14,jvj+13,R,jvj+15)*/
...
pile[v[22]]=jvj+21; pile[WZ1]=3902; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3902,246,jvj+22)*/
...
(*f[2058])( );     /*VAUT0(jvj+19,164,jvj+14,V20)*/
