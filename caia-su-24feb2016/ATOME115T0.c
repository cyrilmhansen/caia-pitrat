...
(*f[1950])( );if(v[102]) goto l7;     /*FNDOND0(498,jvj+8,jvj+10)*/
...
(*f[1977])( );if(v[102]) goto l7;     /*FNDCND0(164,D,V5)*/
V5=pile[WZ2]; 
x[jvj+7]=0 ;z[jvj+7]=0;
pile[v[22]]=509; pile[WZ2]=jvj+6; 
(*f[1971])( );     /*FNDEND0(509,D,jvj+6)*/
l1:if((x[jvj+6]>0)) goto l2;
pile[v[22]]=D; pile[WZ1]=jvj+12; 
(*f[1292])( );if(v[102]) goto l7;     /*DEPEXP0(D,jvj+12)*/
V19=V5-1;
...
(*f[1591])( );     /*SUBSTITUTION0(jvj+12,jvj+14,jvj+13,jvj+15)*/
...
pile[v[22]]=jvj+20; pile[WZ1]=3484; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3484,246,jvj+21)*/
