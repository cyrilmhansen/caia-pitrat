...
(*f[1950])( );if(v[102]) goto l6;     /*FNDOND0(498,jvj+14,jvj+15)*/
...
pile[v[22]]=jvj+21; pile[WZ1]=3323; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3323,246,jvj+22)*/
...
(*f[2058])( );     /*VAUT0(jvj+18,280,jvj+19,V1)*/
x[jvj+4]=t[x[jvj+4]];
goto l5;
}
