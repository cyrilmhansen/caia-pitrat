...
(*f[1971])( );     /*FNDEND0(489,A,jvj+4)*/
for(i=x[jvj+4],V1=0;i>0;i=t[i],V1++)  ;
pile[v[22]]=498; pile[WZ2]=jvj+5; 
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,A,jvj+5)*/
pile[v[22]]=688; pile[WZ1]=jvj+5; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(688,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1<=V3)) goto l1;
...
pile[v[22]]=jvj+8; pile[WZ1]=3426; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3426,246,jvj+9)*/
