...
(*f[2166])( );if(v[102]) goto l25;     /*DMQ0(X,jvj+79,V103,jvj+6)*/
...
(*f[2165])( );     /*COPY0(jvj+100,jvj+96,R,X,RM)*/
x[RES]=67 ;z[RES]=67;
...
(*f[2167])( );     /*COPQ0(jvj+94,jvj+94,jvj+94,jvj+6)*/
...
(*f[2086])( );     /*COPK0(jvj+84,R,jvj+83,VT,V68)*/
...
(*f[2086])( );     /*COPK0(jvj+89,R,jvj+88,VL,WW)*/
(*f[1819])( );     /*NOUV2(VN)*/
VN=pile[v[22]]; 
