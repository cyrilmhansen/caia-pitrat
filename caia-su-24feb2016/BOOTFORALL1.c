...
(*f[1505])( );if(v[102]) goto l3;     /*BOOTRADA0(C,BA,jvj+5,jvj+6)*/
...
(*f[1505])( );if(v[102]) goto l3;     /*BOOTRADA0(C,BA,jvj+8,jvj+9)*/
...
(*f[1505])( );if(v[102]) goto l7;     /*BOOTRADA0(C,BA,jvj+12,jvj+13)*/
