...
(*f[1950])( );if(v[102]) goto l13;     /*FNDOND0(498,A,jvj+10)*/
pile[v[22]]=472; pile[WZ1]=jvj+10; 
(*f[1977])( );if(v[102]) goto l13;     /*FNDCND0(472,jvj+10,V2)*/
V2=pile[WZ2]; 
pile[v[22]]=750; 
(*f[1977])( );if(v[102]) goto l13;     /*FNDCND0(750,jvj+10,V3)*/
V3=pile[WZ2]; 
V7=V8*V3;
x[jvj+7]=0 ;z[jvj+7]=0;
...
pile[v[22]]=jvj+16; pile[WZ1]=3433; pile[WZ2]=246; pile[WZ3]=jvj+17; 
(*f[189])( );     /*TRI4(jvj+16,3433,246,jvj+17)*/
