...
{int V6=0,V11=0,V16=0,V1=0,V27=0,V24=0,V29=0,V25=0;
int R,DD;
...
(*f[1950])( );if(v[102]) goto l16;     /*FNDOND0(498,DD,jvj+8)*/
pile[v[22]]=473; pile[WZ1]=jvj+8; 
(*f[1977])( );if(v[102]) goto l16;     /*FNDCND0(473,jvj+8,V25)*/
V25=pile[WZ2]; 
if((V25!=1)) goto l16;
...
(*f[1971])( );     /*FNDEND0(365,jvj+5,jvj+22)*/
...
(*f[1971])( );     /*FNDEND0(489,jvj+3,jvj+23)*/
...
(*f[1971])( );     /*FNDEND0(365,DD,jvj+16)*/
pile[WZ1]=jvj+3; pile[WZ2]=jvj+17; 
(*f[1971])( );     /*FNDEND0(365,jvj+3,jvj+17)*/
...
pile[v[22]]=jvj+26; pile[WZ1]=3314; pile[WZ2]=246; pile[WZ3]=jvj+27; 
(*f[189])( );     /*TRI4(jvj+26,3314,246,jvj+27)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+5,jvj+13,jvj+24)*/
...
(*f[1977])( );if(v[102]) goto l7;     /*FNDCND0(688,jvj+8,V16)*/
V16=pile[WZ2]; 
if((V16!=1)) goto l7;
pile[v[22]]=498; pile[WZ1]=jvj+5; pile[WZ2]=jvj+11; 
(*f[1950])( );if(v[102]) goto l7;     /*FNDOND0(498,jvj+5,jvj+11)*/
...
pile[v[22]]=688; pile[WZ1]=jvj+8; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(688,jvj+8,V11)*/
V11=pile[WZ2]; 
if((V11!=1)) goto l1;
pile[v[22]]=498; pile[WZ1]=jvj+3; pile[WZ2]=jvj+9; 
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,jvj+3,jvj+9)*/
...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,jvj+3,jvj+4)*/
pile[WZ1]=jvj+5; pile[WZ2]=jvj+6; 
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,jvj+5,jvj+6)*/
if((x[jvj+4]!=x[jvj+6])) goto l2;
pile[v[22]]=688; pile[WZ1]=jvj+6; 
(*f[1977])( );if(v[102]) goto l2;     /*FNDCND0(688,jvj+6,V6)*/
V6=pile[WZ2]; 
if((V6==1)) goto l8;
l2:pile[v[22]]=R; pile[WZ1]=jvj+5; pile[WZ2]=jvj+13; pile[WZ3]=DD; pile[WZ4]=jvj+14; pile[WZ5]=jvj+3; pile[v[22]+6]=jvj+15; 
(*f[3083])( );if(v[102]) goto l15;     /*EVLM2(R,jvj+5,jvj+13,DD,jvj+14,jvj+3,jvj+15,V1)*/
V1=pile[v[22]+7]; 
if((V1!=135)) goto l8;
goto l15;
