...
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(472,N,V3)*/
V3=pile[WZ2]; 
if((V3!=1)) goto l1;
pile[v[22]]=473; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(473,N,V4)*/
V4=pile[WZ2]; 
if((V4!=1)) goto l1;
pile[v[22]]=688; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(688,N,V5)*/
V5=pile[WZ2]; 
pile[v[22]]=750; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(750,N,V6)*/
V6=pile[WZ2]; 
if((V5!=V6)) goto l1;
...
pile[v[22]]=jvj+7; pile[WZ1]=3429; pile[WZ2]=246; pile[WZ3]=jvj+8; 
(*f[189])( );     /*TRI4(jvj+7,3429,246,jvj+8)*/
