...
{int V36=0,V20=0,V23=0,V22=0,V25=0,V26=0,V38=0,V28=0,V27=0,V19=0;
int C;
...
(*f[1977])( );if(v[102]) goto l11;     /*FNDCND0(473,C,V25)*/
V25=pile[WZ2]; 
if((V25!=1)) goto l11;
pile[v[22]]=472; 
(*f[1977])( );if(v[102]) goto l11;     /*FNDCND0(472,C,V26)*/
V26=pile[WZ2]; 
if((V26!=1)) goto l11;
...
(*f[1977])( );if(v[102]) goto l11;     /*FNDCND0(688,C,V28)*/
V28=pile[WZ2]; 
pile[v[22]]=750; 
(*f[1977])( );if(v[102]) goto l11;     /*FNDCND0(750,C,V27)*/
V27=pile[WZ2]; 
if((V27!=V28)) goto l11;
...
(*f[1977])( );if(v[102]) goto l12;     /*FNDCND0(929,jvj+17,V36)*/
V36=pile[WZ2]; 
...
pile[v[22]]=jvj+37; pile[WZ1]=3976; pile[WZ2]=246; pile[WZ3]=jvj+38; 
(*f[189])( );     /*TRI4(jvj+37,3976,246,jvj+38)*/
...
(*f[1293])( );if(v[102]) goto l6;     /*CONVEXP0(jvj+7,jvj+8)*/
