...
{int V32=0,V26=0,V31=0,V23=0,V28=0,V25=0,V22=0,V54=0,V56=0,V64=0,V57=0,V62=0,V7=0,V72=0,V74=0,V82=0,V75=0,V80=0,V90=0,V92=0,V100=0,V93=0,V98=0;
int VV;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
jvj=v[0];
...
pile[v[22]]=202; pile[WZ1]=VV; pile[WZ2]=jvj+15; 
(*f[1950])( );if(v[102]) goto l16;     /*FNDOND0(202,VV,jvj+15)*/
...
V32=pile[WZ2]; 
pile[v[22]]=365; pile[WZ1]=VV; pile[WZ2]=jvj+17; 
(*f[1971])( );     /*FNDEND0(365,VV,jvj+17)*/
for(i=x[jvj+17],V26=0;i>0;i=t[i],V26++)  ;
pile[v[22]]=509; pile[WZ2]=jvj+18; 
(*f[1971])( );     /*FNDEND0(509,VV,jvj+18)*/
...
if((V31!=3)) goto l8;
for(a=x[jvj+20];a>0;a=t[a]) if(s[a]==x[VV]) goto l10;
...
(*f[1721])( );     /*SUBSTITUTES0(VV,jvj+3,jvj+4,jvj+5)*/
pile[v[22]]=jvj+6; pile[WZ1]=jvj+7; 
(*f[1974])( );if(v[102]) goto l15;     /*INVEXP0(jvj+6,jvj+7)*/
pile[v[22]]=jvj+8; pile[WZ2]=jvj+5; pile[WZ3]=jvj+9; 
(*f[1721])( );     /*SUBSTITUTES0(jvj+8,jvj+7,jvj+5,jvj+9)*/
...
x[jvj+6]=s[x[jvj+66]] ;z[jvj+6]=(x[jvj+6]<=sepcte) ? x[jvj+6] : z[jvj+66];
...
pile[v[22]]=365; pile[WZ1]=VV; pile[WZ2]=jvj+36; 
(*f[33])( );     /*FNDE0(365,VV,jvj+36)*/
l18:if((x[jvj+36]>0)) goto l19;
x[jvj+70]=x[jvj+38] ;z[jvj+70]=z[jvj+38];
pile[v[22]]=100; pile[WZ1]=jvj+6; pile[WZ2]=jvj+45; 
(*f[32])( );if(v[102]) goto l5;     /*FNDO0(100,jvj+6,jvj+45)*/
if((x[jvj+52]=w[x[jvj+45]][3])==incon) goto l5;
x[jvj+48]=0 ;z[jvj+48]=0;
pile[v[22]]=365; pile[WZ1]=VV; pile[WZ2]=jvj+46; 
(*f[33])( );     /*FNDE0(365,VV,jvj+46)*/
...
x[jvj+8]=s[x[jvj+68]] ;z[jvj+8]=(x[jvj+8]<=sepcte) ? x[jvj+8] : z[jvj+68];
if((x[jvj+8]==x[jvj+21])) goto l13;
if((x[VV]==x[jvj+8])) goto l13;
pile[v[22]]=202; pile[WZ1]=jvj+8; pile[WZ2]=jvj+24; 
(*f[1950])( );if(v[102]) goto l13;     /*FNDOND0(202,jvj+8,jvj+24)*/
if((x[jvj+24]!=68)) goto l13;
pile[v[22]]=365; pile[WZ2]=jvj+25; 
(*f[1971])( );     /*FNDEND0(365,jvj+8,jvj+25)*/
for(i=x[jvj+25],V28=0;i>0;i=t[i],V28++)  ;
V25=V26*V28;
V22=V23*V25;
if((V22>=500)) goto l13;
...
pile[v[22]]=365; pile[WZ1]=jvj+8; pile[WZ2]=jvj+56; 
(*f[33])( );     /*FNDE0(365,jvj+8,jvj+56)*/
...
l17:pile[v[22]]=101; pile[WZ1]=VV; pile[WZ2]=110; pile[WZ3]=(-671); pile[WZ4]=jvj+33; 
(*f[270])( );     /*QUADRI7(101,VV,110,(-671),jvj+33)*/
...
pile[v[22]]=jvj+30; pile[WZ1]=3948; pile[WZ2]=246; pile[WZ3]=jvj+31; 
(*f[189])( );     /*TRI4(jvj+30,3948,246,jvj+31)*/
pile[v[22]]=jvj+31; pile[WZ1]=20564; pile[WZ2]=218; pile[WZ3]=jvj+32; 
(*f[58])( );     /*TRI3(jvj+31,20564,218,jvj+32)*/
...
for(a=x[jvj+37];a>0;a=t[a]) if(s[a]==x[VV]) goto l24;
...
(*f[26])( );if(v[102]) goto l27;     /*FNDC0(688,jvj+6,V72)*/
V72=pile[WZ2]; 
if((V72==1)) goto l31;
l27:pile[v[22]]=921; pile[WZ1]=jvj+8; pile[WZ2]=jvj+47; 
(*f[33])( );     /*FNDE0(921,jvj+8,jvj+47)*/
for(a=x[jvj+47];a>0;a=t[a]) if(s[a]==x[VV]) goto l31;
...
V80=pile[WZ2]; 
V75=V80;
pile[v[22]]=jvj+6; pile[WZ3]=jvj+53; 
(*f[45])( );if(v[102]) goto l30;     /*FNDZ0(jvj+6,jvj+52,V82,jvj+53)*/
V82=pile[WZ2]; 
V74=V82;
if((V75!=V74)) goto l28;
l30:pile[v[22]]=498; pile[WZ1]=jvj+49; pile[WZ2]=jvj+51; 
(*f[32])( );if(v[102]) goto l29;     /*FNDO0(498,jvj+49,jvj+51)*/
pile[WZ1]=jvj+6; pile[WZ2]=jvj+50; 
(*f[32])( );if(v[102]) goto l29;     /*FNDO0(498,jvj+6,jvj+50)*/
...
for(a=x[jvj+57];a>0;a=t[a]) if(s[a]==x[jvj+8]) goto l38;
