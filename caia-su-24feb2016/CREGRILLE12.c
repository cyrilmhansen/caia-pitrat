...
(*f[1011])( );if(v[102]) goto l21;     /*FVECT0(P,(-630),V12)*/
V12=pile[WZ2]; 
if((V12!=R)) goto l21;
...
(*f[1011])( );if(v[102]) goto l2;     /*FVECT0(XX,(-630),V5)*/
V5=pile[WZ2]; 
if((V5!=X)) goto l2;
...
(*f[1011])( );if(v[102]) goto l7;     /*FVECT0(YY,(-630),V11)*/
V11=pile[WZ2]; 
if((V11!=Y)) goto l7;
...
(*f[1011])( );if(v[102]) goto l15;     /*FVECT0(PP,(-630),V15)*/
V15=pile[WZ2]; 
if((V15!=R)) goto l15;
...
pile[v[22]]=PP; pile[WZ1]=(-630); 
(*f[1011])( );if(v[102]) goto l18;     /*FVECT0(PP,(-630),V18)*/
V18=pile[WZ2]; 
if((V18!=R)) goto l18;
...
(*f[1011])( );if(v[102]) goto l26;     /*FVECT0(QQ,(-622),V25)*/
V25=pile[WZ2]; 
if((V25!=Q)) goto l26;
...
(*f[1011])( );if(v[102]) goto l38;     /*FVECT0(T,(-622),V26)*/
V26=pile[WZ2]; 
if((V26!=RR)) goto l38;
...
(*f[1011])( );if(v[102]) goto l35;     /*FVECT0(TT,(-622),V29)*/
V29=pile[WZ2]; 
if((V29!=RR)) goto l35;
