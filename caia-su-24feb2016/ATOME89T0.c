...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(498,jvj+5,jvj+6)*/
...
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(280,jvj+2,V6)*/
V6=pile[WZ2]; 
if((V5<V6)) goto l9;
l1:pile[v[22]]=164; pile[WZ1]=jvj+2; 
(*f[1977])( );if(v[102]) goto l7;     /*FNDCND0(164,jvj+2,V8)*/
V8=pile[WZ2]; 
if((V5>V8)) goto l9;
...
pile[v[22]]=jvj+26; pile[WZ1]=3210; pile[WZ2]=246; pile[WZ3]=jvj+27; 
(*f[189])( );     /*TRI4(jvj+26,3210,246,jvj+27)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+20,jvj+23,jvj+24)*/
goto l7;
}
