...
(*f[1602])( );     /*DVA0(R,jvj+2)*/
pile[WZ1]=jvj+17; 
(*f[1602])( );     /*DVA0(R,jvj+17)*/
l7:pile[v[22]]=R; pile[WZ1]=N; pile[WZ2]=jvj+17; 
(*f[1640])( );     /*DEKB0(R,N,jvj+17)*/
