...
(*f[1971])( );     /*FNDEND0(509,jvj+46,jvj+47)*/
...
pile[v[22]]=jvj+59; pile[WZ1]=3178; pile[WZ2]=246; pile[WZ3]=jvj+60; 
(*f[189])( );     /*TRI4(jvj+59,3178,246,jvj+60)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+48,jvj+49)*/
goto l46;
}
