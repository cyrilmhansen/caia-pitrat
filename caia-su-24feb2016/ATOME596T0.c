...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(202,jvj+4,jvj+5)*/
if((x[jvj+5]!=68)) goto l2;
pile[v[22]]=365; pile[WZ2]=jvj+6; 
(*f[1971])( );     /*FNDEND0(365,jvj+4,jvj+6)*/
...
(*f[1974])( );if(v[102]) goto l4;     /*INVEXP0(jvj+7,jvj+8)*/
pile[v[22]]=jvj+4; pile[WZ2]=R; pile[WZ3]=jvj+9; 
(*f[1721])( );     /*SUBSTITUTES0(jvj+4,jvj+8,R,jvj+9)*/
...
pile[v[22]]=jvj+15; pile[WZ1]=3856; pile[WZ2]=246; pile[WZ3]=jvj+16; 
(*f[189])( );     /*TRI4(jvj+15,3856,246,jvj+16)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+4,jvj+7,jvj+13)*/
