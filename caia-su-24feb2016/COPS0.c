...
(*f[1820])( );     /*COPV0(RM,BT,X,R,jvj+109)*/
...
(*f[1820])( );     /*COPV0(RM,BT,X,R,jvj+115)*/
goto l43;
...
(*f[2086])( );     /*COPK0(jvj+124,R,jvj+123,V42,W)*/
...
(*f[1820])( );     /*COPV0(RM,BT,X,R,jvj+139)*/
goto l32;
