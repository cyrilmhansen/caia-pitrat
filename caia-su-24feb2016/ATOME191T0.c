...
(*f[1950])( );if(v[102]) goto l5;     /*FNDOND0(498,jvj+2,jvj+3)*/
...
pile[v[22]]=jvj+12; 
(*f[1162])( );if(v[102]) goto l4;     /*SUP0(jvj+12,V2)*/
V2=pile[WZ1]; 
...
pile[v[22]]=jvj+14; 
(*f[1163])( );if(v[102]) goto l4;     /*INF0(jvj+14,V3)*/
V3=pile[WZ1]; 
if((V2>=V3)) goto l4;
...
pile[v[22]]=jvj+17; pile[WZ1]=3416; pile[WZ2]=246; pile[WZ3]=jvj+18; 
(*f[189])( );     /*TRI4(jvj+17,3416,246,jvj+18)*/
