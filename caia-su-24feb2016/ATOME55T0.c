...
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,jvj+3,jvj+4)*/
...
(*f[3107])( );if(v[102]) goto l1;     /*TROUVE0(V2,D,jvj+7)*/
pile[v[22]]=489; pile[WZ2]=jvj+2; 
(*f[1971])( );     /*FNDEND0(489,D,jvj+2)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=3106; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3106,246,jvj+11)*/
...
(*f[1755])( );     /*LIER1(jvj+8,489,D,jvj+7)*/
