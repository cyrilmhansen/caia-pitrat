...
(*f[1599])( );if(v[102]) goto l4;     /*LFACT1(DR,67,DZ,jvj+3)*/
DZ=pile[WZ2]; 
...
(*f[1600])( );if(v[102]) goto l1;     /*LOR1(V2,EX,K,DY)*/
DY=pile[WZ3]; 
...
(*f[1377])( );if(v[102]) goto l3;     /*LAND0(DR,jvj+4,67,DA,jvj+5,jvj+6)*/
DA=pile[WZ3]; 
pile[v[22]]=DA; 
...
(*f[1600])( );if(v[102]) goto l3;     /*LOR1(V6,EX,K,DY)*/
DY=pile[WZ3]; 
goto l5;
