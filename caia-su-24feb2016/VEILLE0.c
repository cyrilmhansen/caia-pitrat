...
(*f[1279])( );if(v[102]) goto l29;     /*TRVLIM0(V175,jvj+24,0,IA)*/
IA=pile[WZ3]; 
V179=V162*V152;
V178=V179/100;
pile[v[22]]=V178; 
(*f[1279])( );if(v[102]) goto l29;     /*TRVLIM0(V178,jvj+24,0,IB)*/
IB=pile[WZ3]; 
V186=IA-1;
V188=IB-1;
...
(*f[1260])( );if(v[102]) goto l69;     /*ACHEVE0(N)*/
N=pile[v[22]]; 
...
(*f[1260])( );if(v[102]) goto l110;     /*ACHEVE0(NN)*/
NN=pile[v[22]]; 
goto l106;
