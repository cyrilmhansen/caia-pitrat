...
(*f[1950])( );if(v[102]) goto l14;     /*FNDOND0(498,jvj+19,jvj+41)*/
...
(*f[3132])( );if(v[102]) goto l10;     /*SUBSTITUVAR1(jvj+14,jvj+22,jvj+23,jvj+17,jvj+24)*/
if((x[jvj+24]==135)) goto l8;
l10:x[jvj+59]=t[x[jvj+59]];
goto l9;
l3:pile[v[22]]=688; pile[WZ1]=jvj+6; 
(*f[1977])( );if(v[102]) goto l16;     /*FNDCND0(688,jvj+6,V15)*/
V15=pile[WZ2]; 
if((V15==1)) goto l14;
...
pile[v[22]]=jvj+48; pile[WZ1]=3153; pile[WZ2]=246; pile[WZ3]=jvj+49; 
(*f[189])( );     /*TRI4(jvj+48,3153,246,jvj+49)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+17,jvj+25)*/
...
pile[v[22]]=jvj+53; pile[WZ1]=3153; pile[WZ2]=246; pile[WZ3]=jvj+54; 
(*f[189])( );     /*TRI4(jvj+53,3153,246,jvj+54)*/
