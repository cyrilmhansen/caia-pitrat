...
(*f[3189])( );if(v[102]) goto l18;     /*ENTRAINE0(V22,jvj+15,V23,jvj+42,jvj+43)*/
...
pile[v[22]]=jvj+66; pile[WZ1]=3371; pile[WZ2]=246; pile[WZ3]=jvj+67; 
(*f[189])( );     /*TRI4(jvj+66,3371,246,jvj+67)*/
...
(*f[1560])( );     /*RESTAURE0(RR,jvj+48,jvj+49)*/
goto l18;
