...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(498,jvj+5,jvj+7)*/
pile[v[22]]=473; pile[WZ1]=jvj+7; 
(*f[1977])( );if(v[102]) goto l8;     /*FNDCND0(473,jvj+7,V9)*/
V9=pile[WZ2]; 
if((V9!=1)) goto l8;
pile[v[22]]=509; pile[WZ1]=jvj+5; pile[WZ2]=jvj+8; 
(*f[1971])( );     /*FNDEND0(509,jvj+5,jvj+8)*/
...
(*f[1971])( );     /*FNDEND0(365,jvj+5,jvj+9)*/
