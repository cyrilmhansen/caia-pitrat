...
(*f[1030])( );     /*DIFFAPP0(jvj+20,jvj+18,jvj+21)*/
...
pile[v[22]]=jvj+24; pile[WZ1]=3832; pile[WZ2]=246; pile[WZ3]=jvj+25; 
(*f[189])( );     /*TRI4(jvj+24,3832,246,jvj+25)*/
...
(*f[1755])( );     /*LIER1(jvj+22,489,jvj+9,jvj+20)*/
goto l4;
}
