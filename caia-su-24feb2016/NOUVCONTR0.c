...
(*f[1550])( );     /*NOUVCONTRA0(jvj+19,250,HIST)*/
...
(*f[1357])( );if(v[102]) goto l13;     /*SUBSTOTAL0(jvj+2,jvj+18,jvj+25)*/
pile[v[22]]=jvj+25; pile[WZ1]=HIST; 
(*f[1298])( );     /*NOUVCONTR0(jvj+25,HIST)*/
...
(*f[1292])( );if(v[102]) goto l7;     /*DEPEXP0(jvj+14,jvj+16)*/
...
(*f[1550])( );     /*NOUVCONTRA0(jvj+2,jvj+27,HIST)*/
goto l15;
}
