...
(*f[1118])( );     /*CRINSTA0(BL,V105,jvj+24)*/
...
(*f[1118])( );     /*CRINSTA0(BL,V105,jvj+23)*/
goto l10;
...
(*f[1118])( );     /*CRINSTA0(BL,V104,jvj+20)*/
goto l10;
l12:V51=V123;
pile[v[22]]=V51; pile[WZ1]=BL; pile[WZ2]=jvj+21; 
(*f[1119])( );     /*TROUVEREL0(V51,BL,jvj+21)*/
x[jvj+8]=0 ;z[jvj+8]=0;
