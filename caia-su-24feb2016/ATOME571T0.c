...
(*f[1977])( );if(v[102]) goto l12;     /*FNDCND0(929,jvj+16,V36)*/
V36=pile[WZ2]; 
...
pile[v[22]]=jvj+36; pile[WZ1]=3960; pile[WZ2]=246; pile[WZ3]=jvj+37; 
(*f[189])( );     /*TRI4(jvj+36,3960,246,jvj+37)*/
...
(*f[1293])( );if(v[102]) goto l6;     /*CONVEXP0(jvj+6,jvj+7)*/
