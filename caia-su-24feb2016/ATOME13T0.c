...
(*f[1977])( );if(v[102]) goto l5;     /*FNDCND0(750,N,V3)*/
V3=pile[WZ2]; 
...
(*f[1971])( );     /*FNDEND0(489,jvj+4,jvj+7)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3057; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3057,246,jvj+12)*/
...
(*f[1755])( );     /*LIER1(jvj+8,489,jvj+9,jvj+4)*/
