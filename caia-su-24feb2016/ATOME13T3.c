...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,A,jvj+5)*/
...
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(750,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1!=V3)) goto l4;
pile[v[22]]=489; pile[WZ1]=A; pile[WZ2]=jvj+7; 
(*f[1971])( );     /*FNDEND0(489,A,jvj+7)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3281; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3281,246,jvj+12)*/
...
(*f[1755])( );     /*LIER1(jvj+8,489,jvj+9,A)*/
