...
(*f[1374])( );if(v[102]) goto l17;     /*LFACTA0(DR,jvj+3,DZ)*/
DZ=pile[WZ2]; 
if((x[S]!=68)) goto l1;
...
(*f[1377])( );if(v[102]) goto l6;     /*LAND0(DR,jvj+4,68,DM,jvj+8,jvj+9)*/
DM=pile[WZ3]; 
goto l6;
...
(*f[1376])( );if(v[102]) goto l17;     /*LOR0(DR,jvj+9,DN,jvj+10)*/
DN=pile[WZ2]; 
...
(*f[1375])( );if(v[102]) goto l15;     /*LFACTA1(DN,jvj+10,EX,DY)*/
DY=pile[WZ3]; 
goto l18;
}
