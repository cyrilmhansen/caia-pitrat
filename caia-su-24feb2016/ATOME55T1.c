...
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,jvj+4,jvj+5)*/
...
(*f[3107])( );if(v[102]) goto l1;     /*TROUVE0(V2,D,jvj+8)*/
pile[v[22]]=489; pile[WZ2]=jvj+3; 
(*f[1971])( );     /*FNDEND0(489,D,jvj+3)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3412; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3412,246,jvj+12)*/
...
(*f[1755])( );     /*LIER1(jvj+9,489,D,jvj+8)*/
