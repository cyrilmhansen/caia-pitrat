...
(*f[1971])( );     /*FNDEND0(489,DD,jvj+3)*/
if((x[jvj+3]!=0)) goto l6;
pile[v[22]]=498; pile[WZ2]=jvj+4; 
(*f[1950])( );if(v[102]) goto l6;     /*FNDOND0(498,DD,jvj+4)*/
pile[v[22]]=473; pile[WZ1]=jvj+4; 
(*f[1977])( );if(v[102]) goto l6;     /*FNDCND0(473,jvj+4,V5)*/
V5=pile[WZ2]; 
if((V5!=1)) goto l6;
pile[v[22]]=365; pile[WZ1]=DD; pile[WZ2]=jvj+5; 
(*f[1971])( );     /*FNDEND0(365,DD,jvj+5)*/
...
pile[v[22]]=jvj+9; pile[WZ1]=3080; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3080,246,jvj+10)*/
