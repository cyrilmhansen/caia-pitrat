...
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,jvj+15,jvj+16)*/
pile[v[22]]=688; pile[WZ1]=jvj+16; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(688,jvj+16,V2)*/
V2=pile[WZ2]; 
if((V2!=1)) goto l1;
...
pile[v[22]]=jvj+19; pile[WZ1]=3139; pile[WZ2]=246; pile[WZ3]=jvj+20; 
(*f[189])( );     /*TRI4(jvj+19,3139,246,jvj+20)*/
...
(*f[1049])( );     /*EVENEMENT0(jvj+17,27,jvj+15)*/
