...
(*f[3161])( );if(v[102]) goto l13;     /*FACTEURS0(R,jvj+5,jvj+6,RT)*/
RT=pile[WZ3]; 
V13=RT-3;
V3=incon;
...
(*f[3160])( );if(v[102]) goto l15;     /*REDIV0(R,L,jvj+12)*/
...
pile[v[22]]=jvj+15; pile[WZ1]=3159; pile[WZ2]=246; pile[WZ3]=jvj+16; 
(*f[189])( );     /*TRI4(jvj+15,3159,246,jvj+16)*/
