...
(*f[3107])( );if(v[102]) goto l6;     /*TROUVE0(L,jvj+17,jvj+18)*/
...
pile[v[22]]=jvj+21; pile[WZ1]=3330; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3330,246,jvj+22)*/
...
(*f[1755])( );     /*LIER1(jvj+19,489,jvj+17,jvj+18)*/
