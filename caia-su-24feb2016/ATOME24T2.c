...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,jvj+22,jvj+23)*/
pile[v[22]]=688; pile[WZ1]=jvj+23; 
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(688,jvj+23,V10)*/
V10=pile[WZ2]; 
if((V10!=1)) goto l4;
...
(*f[1971])( );     /*FNDEND0(509,jvj+33,jvj+34)*/
...
pile[v[22]]=jvj+38; pile[WZ1]=3263; pile[WZ2]=246; pile[WZ3]=jvj+39; 
(*f[189])( );     /*TRI4(jvj+38,3263,246,jvj+39)*/
