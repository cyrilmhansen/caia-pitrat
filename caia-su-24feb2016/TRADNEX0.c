...
(*f[2048])( );     /*TRADNEXA0(N,EX,jvj+2,jvj+3)*/
if((x[IV]!=576)) goto l3;
pile[v[22]]=VV; pile[WZ1]=129; pile[WZ2]=BA; 
(*f[1508])( );     /*NATFNS0(VV,129,BA)*/
