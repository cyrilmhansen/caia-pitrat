...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(498,jvj+9,jvj+10)*/
...
(*f[1977])( );if(v[102]) goto l8;     /*FNDCND0(280,D,V7)*/
V7=pile[WZ2]; 
if((V7<0)) goto l8;
x[jvj+8]=0 ;z[jvj+8]=0;
...
pile[v[22]]=jvj+22; pile[WZ1]=3526; pile[WZ2]=246; pile[WZ3]=jvj+23; 
(*f[189])( );     /*TRI4(jvj+22,3526,246,jvj+23)*/
