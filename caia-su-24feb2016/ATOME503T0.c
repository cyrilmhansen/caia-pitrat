...
(*f[1977])( );if(v[102]) goto l3;     /*FNDCND0(688,V,V4)*/
V4=pile[WZ2]; 
pile[v[22]]=489; pile[WZ2]=jvj+2; 
(*f[1971])( );     /*FNDEND0(489,V,jvj+2)*/
...
(*f[1030])( );     /*DIFFAPP0(jvj+5,jvj+2,jvj+6)*/
...
pile[v[22]]=jvj+9; pile[WZ1]=3939; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3939,246,jvj+10)*/
...
(*f[1571])( );     /*DELIER0(365,V,jvj+5,jvj+7)*/
goto l2;
}
