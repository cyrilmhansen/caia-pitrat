...
(*f[1162])( );if(v[102]) goto l6;     /*SUP0(X,V2)*/
V2=pile[WZ1]; 
...
(*f[1163])( );if(v[102]) goto l2;     /*INF0(jvj+14,V3)*/
V3=pile[WZ1]; 
if((V2>=V3)) goto l2;
V19=x[jvj+9];
l3:if((V19<=0)) goto l2;
...
pile[v[22]]=jvj+18; pile[WZ1]=3343; pile[WZ2]=246; pile[WZ3]=jvj+19; 
(*f[189])( );     /*TRI4(jvj+18,3343,246,jvj+19)*/
