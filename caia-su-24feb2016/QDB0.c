...
(*f[2127])( );     /*COUPENS0(50,jvj+42,jvj+43)*/
V58=0;
...
(*f[1983])( );if(v[102]) goto l24;     /*SPSS0(V19,jvj+4,V20)*/
V20=pile[WZ2]; 
...
(*f[1806])( );     /*SPE0(V59,jvj+13,32,21,V57)*/
V57=pile[WZ4]; 
pile[v[22]]=V57; 
(*f[289])( );     /*SPLN1(V57)*/
x[jvj+43]=t[x[jvj+43]];
...
(*f[1806])( );     /*SPE0(V66,jvj+29,32,480,V64)*/
V64=pile[WZ4]; 
pile[v[22]]=V64; 
(*f[289])( );     /*SPLN1(V64)*/
