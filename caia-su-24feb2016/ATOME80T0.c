...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,jvj+14,jvj+2)*/
...
pile[v[22]]=jvj+21; pile[WZ1]=3779; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3779,246,jvj+22)*/
...
(*f[2058])( );     /*VAUT0(jvj+18,280,jvj+19,V11)*/
x[jvj+17]=t[x[jvj+17]];
goto l3;
}
