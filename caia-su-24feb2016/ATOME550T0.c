...
(*f[1030])( );     /*DIFFAPP0(jvj+6,jvj+5,jvj+7)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=3942; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3942,246,jvj+11)*/
...
(*f[1755])( );     /*LIER1(jvj+8,489,V,jvj+6)*/
goto l2;
}
