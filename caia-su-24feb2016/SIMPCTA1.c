...
(*f[1684])( );if(v[102]) goto l3;     /*SIMPCTA1(jvj+5,jvj+6)*/
pile[v[22]]=510; 
...
(*f[1682])( );if(v[102]) goto l4;     /*PRDFACT0(jvj+8,RES)*/
goto l5;
