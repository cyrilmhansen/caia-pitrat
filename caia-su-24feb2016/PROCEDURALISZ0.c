...
(*f[1510])( );     /*PROCEDURALISB0(jvj+6,jvj+8,N,102,jvj+9,jvj+10)*/
...
(*f[1511])( );     /*PROCEDURALISA0(jvj+15,jvj+16,N,jvj+17,AT,P,V19,jvj+18)*/
...
(*f[1242])( );     /*PROCEDURALISZ0(jvj+20,107,N,jvj+20)*/
x[jvj+19]=t[x[jvj+19]];
goto l3;
}
