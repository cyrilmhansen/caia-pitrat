...
(*f[1971])( );     /*FNDEND0(365,jvj+6,jvj+7)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3442; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3442,246,jvj+12)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+6,jvj+9,jvj+8)*/
goto l4;
}
