...
pile[v[22]]=jvj+18; 
(*f[1163])( );if(v[102]) goto l2;     /*INF0(jvj+18,V2)*/
V2=pile[WZ1]; 
L=V2;
if((L<=0)) goto l2;
V33=K/L;
...
pile[v[22]]=jvj+21; pile[WZ1]=3666; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3666,246,jvj+22)*/
...
(*f[2058])( );     /*VAUT0(jvj+19,164,jvj+17,V33)*/
