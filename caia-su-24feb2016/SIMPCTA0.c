...
(*f[1684])( );if(v[102]) goto l3;     /*SIMPCTA1(jvj+6,jvj+7)*/
pile[v[22]]=510; 
...
(*f[1682])( );if(v[102]) goto l5;     /*PRDFACT0(jvj+9,jvj+4)*/
goto l4;
l5:x[E]=S=incon;
