...
(*f[1932])( );if(v[102]) goto l8;     /*DECTERMES0(RN,jvj+11)*/
...
(*f[1933])( );if(v[102]) goto l5;     /*ISOLONS0(RN,jvj+2,486,jvj+5)*/
x[jvj+16]=incon;
if((v[244]<=0)) goto l9;
...
(*f[1367])( );     /*AJOUTER0(1902,jvj+8,HIST)*/
pile[v[22]]=jvj+8; 
(*f[1597])( );     /*CRETUND0(jvj+8)*/
