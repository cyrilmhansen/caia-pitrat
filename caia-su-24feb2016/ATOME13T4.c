...
(*f[1977])( );if(v[102]) goto l3;     /*FNDCND0(750,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1!=V3)) goto l3;
pile[v[22]]=489; pile[WZ1]=A; pile[WZ2]=jvj+6; 
(*f[1971])( );     /*FNDEND0(489,A,jvj+6)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=3431; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3431,246,jvj+11)*/
...
(*f[1755])( );     /*LIER1(jvj+7,489,jvj+8,A)*/
