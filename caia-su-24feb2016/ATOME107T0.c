...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(202,D,jvj+8)*/
...
(*f[1740])( );if(v[102]) goto l7;     /*EVLM0(jvj+10,D,jvj+11,V1)*/
V1=pile[WZ3]; 
if((V1!=134)) goto l7;
...
pile[v[22]]=jvj+14; pile[WZ1]=3494; pile[WZ2]=246; pile[WZ3]=jvj+15; 
(*f[189])( );     /*TRI4(jvj+14,3494,246,jvj+15)*/
...
(*f[1571])( );     /*DELIER0(365,D,jvj+11,jvj+12)*/
