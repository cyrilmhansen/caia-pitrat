...
(*f[3507])( );if(v[102]) goto l3;     /*INTERPRETATION0(jvj+1,Y,I,L)*/
L=pile[WZ3]; 
...
(*f[3507])( );if(v[102]) goto l8;     /*INTERPRETATION0(jvj+4,Y,I,V24)*/
V24=pile[WZ3]; 
...
(*f[3507])( );if(v[102]) goto l16;     /*INTERPRETATION0(jvj+10,Y,I,RR)*/
RR=pile[WZ3]; 
V5=(-RR);
R=V5;
goto l17;
