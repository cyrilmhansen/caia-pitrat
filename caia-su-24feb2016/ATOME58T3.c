...
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,jvj+16,jvj+17)*/
pile[v[22]]=688; pile[WZ1]=jvj+17; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(688,jvj+17,V2)*/
V2=pile[WZ2]; 
if((V2!=1)) goto l1;
...
pile[v[22]]=jvj+20; pile[WZ1]=3331; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3331,246,jvj+21)*/
...
(*f[1049])( );     /*EVENEMENT0(jvj+18,27,jvj+16)*/
