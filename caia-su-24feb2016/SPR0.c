...
pile[v[22]]=I; 
(*f[2151])( );if(v[102]) goto l1;     /*SPFIN0(I,X,J)*/
J=pile[WZ2]; 
...
(*f[2147])( );if(v[102]) goto l6;     /*SPF0(X,I,J)*/
J=pile[WZ2]; 
goto l18;
...
pile[v[22]]=I; 
(*f[1983])( );if(v[102]) goto l3;     /*SPSS0(I,jvj+7,J)*/
J=pile[WZ2]; 
goto l18;
...
(*f[2148])( );     /*SPBK0(X,I,jvj+26,jvj+25,J)*/
J=pile[WZ4]; 
goto l18;
...
(*f[2146])( );     /*SPD0(jvj+27,jvj+28,V81,V82)*/
V82=pile[WZ3]; 
