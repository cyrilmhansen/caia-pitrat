...
(*f[1123])( );if(v[102]) goto l9;     /*COMPTEVAR2(jvj+15,N,B,RA,SA)*/
...
(*f[1123])( );if(v[102]) goto l16;     /*COMPTEVAR2(jvj+29,N,B,V27,V28)*/
...
(*f[1122])( );     /*COMPTEVAR1(jvj+35,RR,N,B)*/
...
(*f[1122])( );     /*COMPTEVAR1(jvj+38,RR,N,B)*/
x[jvj+42]=t[x[jvj+42]];
goto l27;
}
