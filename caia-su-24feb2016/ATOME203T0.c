...
(*f[1977])( );if(v[102]) goto l2;     /*FNDCND0(280,jvj+15,V3)*/
V3=pile[WZ2]; 
K=V13;
if((V3!=K)) goto l2;
V22=K+1;
...
pile[v[22]]=jvj+18; pile[WZ1]=3562; pile[WZ2]=246; pile[WZ3]=jvj+19; 
(*f[189])( );     /*TRI4(jvj+18,3562,246,jvj+19)*/
...
(*f[2058])( );     /*VAUT0(jvj+16,280,jvj+15,V22)*/
