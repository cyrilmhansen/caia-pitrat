...
(*f[3028])( );if(v[102]) goto l1;     /*EXECUTE0(S,0,RN)*/
RN=pile[WZ2]; 
...
pile[v[22]]=jvj+12; pile[WZ1]=3965; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3965,246,jvj+13)*/
