...
(*f[1262])( );if(v[102]) goto l13;     /*ARBITRAGE0(E,jvj+8)*/
...
pile[v[22]]=K; 
(*f[1265])( );if(v[102]) goto l23;     /*PREMNOUVPB0(K)*/
x[N]=1097 ;z[N]=1097;
...
pile[v[22]]=jvj+19; 
(*f[1264])( );if(v[102]) goto l47;     /*AJEXP2(jvj+19,R)*/
R=pile[WZ1]; 
