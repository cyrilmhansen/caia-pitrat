...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,D,jvj+5)*/
...
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(473,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1!=V3)) goto l4;
...
pile[v[22]]=jvj+11; pile[WZ1]=3218; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3218,246,jvj+12)*/
