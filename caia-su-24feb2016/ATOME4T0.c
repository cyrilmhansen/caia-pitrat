...
(*f[3031])( );if(v[102]) goto l1;     /*EXECUTE1(0,S,jvj+8)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3030; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3030,246,jvj+12)*/
