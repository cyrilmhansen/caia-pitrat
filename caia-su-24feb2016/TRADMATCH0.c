...
(*f[1232])( );if(v[102]) goto l4;     /*TRADMATCH0(B,jvj+8,jvj+9)*/
...
(*f[1232])( );if(v[102]) goto l15;     /*TRADMATCH0(B,jvj+15,jvj+16)*/
...
(*f[1232])( );if(v[102]) goto l19;     /*TRADMATCH0(B,jvj+19,jvj+20)*/
