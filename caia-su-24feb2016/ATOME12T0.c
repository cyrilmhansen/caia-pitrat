...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,A,jvj+4)*/
...
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(688,jvj+4,V3)*/
V3=pile[WZ2]; 
if((V1!=V3)) goto l4;
...
pile[v[22]]=jvj+10; pile[WZ1]=3103; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3103,246,jvj+11)*/
