...
(*f[3044])( );if(v[102]) goto l13;     /*DIFFERE0(766,N,jvj+17)*/
...
(*f[3031])( );if(v[102]) goto l11;     /*EXECUTE1(V23,jvj+17,jvj+23)*/
...
(*f[3053])( );     /*INTERP25(614,20048,0,(-611),V16,(-595),jvj+7,(-620),jvj+4,(-697),jvj+8,jvj+9)*/
