...
(*f[1008])( );if(v[102]) goto l34;     /*DECFACTPREM0(K,jvj+30)*/
V3=incon;
...
(*f[1007])( );if(v[102]) goto l20;     /*POWER0(V138,V125,V112)*/
V112=pile[WZ2]; 
HH=V112;
V111=HH;
l21:H=V111;
...
(*f[1007])( );if(v[102]) goto l17;     /*POWER0(V137,V125,V114)*/
V114=pile[WZ2]; 
GG=V114;
V113=GG;
goto l18;
...
(*f[2023])( );     /*REMPLACE0(NNNY,jvj+25,NNNX)*/
goto l42;
