...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(498,DD,jvj+5)*/
pile[v[22]]=473; pile[WZ1]=jvj+5; 
(*f[1977])( );if(v[102]) goto l8;     /*FNDCND0(473,jvj+5,V7)*/
V7=pile[WZ2]; 
if((V7!=1)) goto l8;
...
pile[v[22]]=jvj+13; pile[WZ1]=3082; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3082,246,jvj+14)*/
