...
(*f[1950])( );if(v[102]) goto l9;     /*FNDOND0(498,jvj+9,jvj+11)*/
...
(*f[1977])( );if(v[102]) goto l9;     /*FNDCND0(280,D,V9)*/
V9=pile[WZ2]; 
if((V9<0)) goto l9;
x[jvj+8]=0 ;z[jvj+8]=0;
...
pile[v[22]]=jvj+24; pile[WZ1]=3518; pile[WZ2]=246; pile[WZ3]=jvj+25; 
(*f[189])( );     /*TRI4(jvj+24,3518,246,jvj+25)*/
