...
(*f[2023])( );     /*REMPLACE0(NNNY,jvj+4,NNNX)*/
...
(*f[2023])( );     /*REMPLACE0(NNNY,jvj+13,NNNX)*/
goto l28;
...
(*f[2023])( );     /*REMPLACE0(NNNY,jvj+52,NNNX)*/
goto l28;
l25:NNNT=135;
