...
(*f[3035])( );if(v[102]) goto l1;     /*ENSARR0(N,jvj+3)*/
...
pile[v[22]]=jvj+7; pile[WZ1]=3040; pile[WZ2]=246; pile[WZ3]=jvj+8; 
(*f[189])( );     /*TRI4(jvj+7,3040,246,jvj+8)*/
...
(*f[3039])( );     /*AJOUNOEUD0(jvj+5,481,N,jvj+4)*/
