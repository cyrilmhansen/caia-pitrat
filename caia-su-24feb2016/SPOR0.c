...
(*f[1643])( );if(v[102]) goto l12;     /*VC0(jvj+17,68,jvj+18)*/
...
(*f[2149])( );     /*SPP0(V217,3,jvj+41,V218)*/
V218=pile[WZ3]; 
...
(*f[2149])( );     /*SPP0(V950,3,jvj+56,V951)*/
V951=pile[WZ3]; 
