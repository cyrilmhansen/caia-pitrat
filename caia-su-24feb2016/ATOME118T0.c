...
(*f[1950])( );if(v[102]) goto l9;     /*FNDOND0(202,D,jvj+7)*/
if((x[jvj+7]!=68)) goto l9;
pile[WZ1]=DD; pile[WZ2]=jvj+8; 
(*f[1950])( );if(v[102]) goto l9;     /*FNDOND0(202,DD,jvj+8)*/
if((x[jvj+8]!=68)) goto l9;
pile[v[22]]=489; pile[WZ2]=jvj+9; 
(*f[1971])( );     /*FNDEND0(489,DD,jvj+9)*/
...
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,DD,jvj+3)*/
pile[v[22]]=688; pile[WZ1]=jvj+3; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(688,jvj+3,V11)*/
V11=pile[WZ2]; 
if((V11==1)) goto l4;
l1:pile[v[22]]=R; pile[WZ1]=D; pile[WZ2]=jvj+4; pile[WZ3]=DD; pile[WZ4]=jvj+5; 
(*f[3079])( );if(v[102]) goto l8;     /*EVLM1(R,D,jvj+4,DD,jvj+5,V1)*/
V1=pile[WZ5]; 
if((V1==134)) goto l4;
...
pile[v[22]]=jvj+17; pile[WZ1]=3499; pile[WZ2]=246; pile[WZ3]=jvj+18; 
(*f[189])( );     /*TRI4(jvj+17,3499,246,jvj+18)*/
...
(*f[1571])( );     /*DELIER0(365,DD,jvj+5,jvj+15)*/
goto l8;
