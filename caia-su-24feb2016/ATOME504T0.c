...
(*f[1950])( );if(v[102]) goto l6;     /*FNDOND0(202,V,jvj+2)*/
...
(*f[1030])( );     /*DIFFAPP0(jvj+6,jvj+4,jvj+7)*/
...
(*f[1030])( );     /*DIFFAPP0(jvj+8,jvj+4,jvj+9)*/
...
(*f[1571])( );     /*DELIER0(489,V,jvj+6,jvj+10)*/
...
(*f[1755])( );     /*LIER1(jvj+11,365,V,jvj+8)*/
goto l5;
}
