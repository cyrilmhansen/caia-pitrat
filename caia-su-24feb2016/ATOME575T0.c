...
pile[v[22]]=472; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(472,C,V2)*/
V2=pile[WZ2]; 
V1=V2*V3;
pile[v[22]]=750; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(750,C,V6)*/
V6=pile[WZ2]; 
V5=V6*V7;
if((V1!=V5)) goto l1;
...
pile[v[22]]=jvj+8; pile[WZ1]=3974; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3974,246,jvj+9)*/
...
pile[v[22]]=jvj+14; pile[WZ1]=3974; pile[WZ2]=246; pile[WZ3]=jvj+15; 
(*f[189])( );     /*TRI4(jvj+14,3974,246,jvj+15)*/
