...
(*f[1008])( );if(v[102]) goto l33;     /*DECFACTPREM0(I,E)*/
...
(*f[1008])( );if(v[102]) goto l40;     /*DECFACTPREM0(V3,jvj+32)*/
...
(*f[1008])( );if(v[102]) goto l42;     /*DECFACTPREM0(J,jvj+34)*/
x[jvj+2]=0 ;z[jvj+2]=0;
