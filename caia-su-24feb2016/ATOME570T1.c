...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(202,V,jvj+7)*/
if((x[jvj+7]!=68)) goto l4;
pile[v[22]]=365; pile[WZ2]=jvj+8; 
(*f[1971])( );     /*FNDEND0(365,V,jvj+8)*/
...
pile[v[22]]=jvj+14; pile[WZ1]=3953; pile[WZ2]=246; pile[WZ3]=jvj+15; 
(*f[189])( );     /*TRI4(jvj+14,3953,246,jvj+15)*/
...
(*f[1293])( );if(v[102]) goto l3;     /*CONVEXP0(jvj+3,jvj+4)*/
