...
(*f[1583])( );     /*MONTECONTR1(V47,KK)*/
l10:V49=tn[KK];
if((V49<=0)) goto l11;
pile[v[22]]=V49; pile[WZ1]=KK; 
(*f[1583])( );     /*MONTECONTR1(V49,KK)*/
