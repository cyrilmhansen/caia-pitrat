...
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(929,jvj+2,V58)*/
V58=pile[WZ2]; 
...
pile[v[22]]=jvj+45; pile[WZ1]=3929; pile[WZ2]=246; pile[WZ3]=jvj+46; 
(*f[189])( );     /*TRI4(jvj+45,3929,246,jvj+46)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+39,jvj+40)*/
goto l20;
}
