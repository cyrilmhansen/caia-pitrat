...
(*f[1950])( );if(v[102]) goto l3;     /*FNDOND0(498,D,jvj+5)*/
pile[v[22]]=472; pile[WZ1]=jvj+5; 
(*f[1977])( );if(v[102]) goto l3;     /*FNDCND0(472,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1!=V3)) goto l3;
...
pile[v[22]]=jvj+10; pile[WZ1]=3493; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3493,246,jvj+11)*/
...
(*f[1571])( );     /*DELIER0(365,D,jvj+8,jvj+7)*/
