...
(*f[1950])( );if(v[102]) goto l3;     /*FNDOND0(498,DD,jvj+4)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=3309; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3309,246,jvj+11)*/
...
(*f[1755])( );     /*LIER1(jvj+7,489,DD,jvj+8)*/
goto l3;
}
