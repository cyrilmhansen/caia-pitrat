...
(*f[1832])( );     /*INTERP23(5,10475,0,28,jvj+13,29,V29,30,jvj+19,(-662),TL,jvj+20)*/
...
(*f[1827])( );     /*FAUTE8(10475,V49,(-4383),jvj+30,jvj+31)*/
...
(*f[1832])( );     /*INTERP23(3,10475,0,(-662),TL,49,V49,48,jvj+27,50,jvj+26,jvj+28)*/
