...
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,D,jvj+4)*/
pile[v[22]]=472; pile[WZ1]=jvj+4; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(472,jvj+4,V3)*/
V3=pile[WZ2]; 
if((V1<=V3)) goto l1;
...
pile[v[22]]=jvj+7; pile[WZ1]=3098; pile[WZ2]=246; pile[WZ3]=jvj+8; 
(*f[189])( );     /*TRI4(jvj+7,3098,246,jvj+8)*/
