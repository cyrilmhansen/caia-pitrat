...
(*f[1977])( );if(v[102]) goto l3;     /*FNDCND0(750,V,V4)*/
V4=pile[WZ2]; 
pile[v[22]]=365; pile[WZ2]=jvj+2; 
(*f[1971])( );     /*FNDEND0(365,V,jvj+2)*/
...
(*f[1030])( );     /*DIFFAPP0(jvj+5,jvj+4,jvj+6)*/
...
pile[v[22]]=jvj+9; pile[WZ1]=3959; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3959,246,jvj+10)*/
...
(*f[1755])( );     /*LIER1(jvj+7,489,V,jvj+5)*/
goto l2;
}
