...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,A,jvj+4)*/
...
(*f[1977])( );if(v[102]) goto l2;     /*FNDCND0(750,jvj+4,V3)*/
V3=pile[WZ2]; 
if((V1>=V3)) goto l2;
...
pile[v[22]]=jvj+8; pile[WZ1]=3066; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3066,246,jvj+9)*/
