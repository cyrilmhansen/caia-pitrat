...
(*f[1950])( );if(v[102]) goto l9;     /*FNDOND0(202,D,jvj+15)*/
...
(*f[1950])( );if(v[102]) goto l8;     /*FNDOND0(202,jvj+4,jvj+5)*/
if((x[jvj+5]==68)) goto l9;
l8:pile[v[22]]=R; pile[WZ1]=jvj+4; pile[WZ2]=68; pile[WZ3]=jvj+9; 
(*f[1933])( );if(v[102]) goto l9;     /*ISOLONS0(R,jvj+4,68,jvj+9)*/
x[jvj+10]=0 ;z[jvj+10]=0;
pile[v[22]]=365; pile[WZ1]=D; pile[WZ2]=jvj+6; 
(*f[1971])( );     /*FNDEND0(365,D,jvj+6)*/
pile[v[22]]=D; pile[WZ1]=jvj+7; 
(*f[1292])( );if(v[102]) goto l5;     /*DEPEXP0(D,jvj+7)*/
...
(*f[3507])( );if(v[102]) goto l4;     /*INTERPRETATION0(jvj+9,jvj+7,V10,RZ)*/
RZ=pile[WZ3]; 
...
(*f[1950])( );if(v[102]) goto l7;     /*FNDOND0(498,jvj+4,jvj+11)*/
l6:if((x[jvj+10]<=0)) goto l7;
II=s[x[jvj+10]];
pile[v[22]]=jvj+11; pile[WZ1]=II; pile[WZ2]=jvj+12; 
(*f[1767])( );     /*AJARR0(jvj+11,II,jvj+12)*/
...
pile[v[22]]=jvj+19; pile[WZ1]=3506; pile[WZ2]=246; pile[WZ3]=jvj+20; 
(*f[189])( );     /*TRI4(jvj+19,3506,246,jvj+20)*/
...
(*f[1755])( );     /*LIER1(jvj+13,365,jvj+4,jvj+12)*/
x[jvj+10]=t[x[jvj+10]];
goto l6;
...
pile[v[22]]=jvj+24; pile[WZ1]=3506; pile[WZ2]=246; pile[WZ3]=jvj+25; 
(*f[189])( );     /*TRI4(jvj+24,3506,246,jvj+25)*/
...
(*f[3042])( );     /*VOBJ0(jvj+17,202,jvj+4,68)*/
