...
{int V38=0,J=0,P=0,I=0,V5=0,V39=0,V40=0,V36=0,V15=0,V24=0,K=0,Q=0,V2=0,V49=0,V50=0,V4=0,V51=0,V53=0,V54=0,V59=0,V60=0,V78=0,V73=0,V62=0,V98=0,V97=0,V95=0,V96=0,V68=0,V64=0,V67=0,V66=0;
int R;
...
(*f[26])( );if(v[102]) goto l9;     /*FNDC0(130,jvj+5,P)*/
P=pile[WZ2]; 
...
J=0;
l1:if((J<=V38)) goto l3;
pile[v[22]]=P; pile[WZ1]=Q; pile[WZ2]=I; 
(*f[1043])( );if(v[102]) goto l8;     /*MODPUI0(P,Q,I,V2)*/
V2=pile[WZ3]; 
if((V2!=1)) goto l8;
...
(*f[3683])( );if(v[102]) goto l24;     /*CROISSANT0(jvj+24,jvj+25)*/
...
l15:V60++;
goto l13;
l3:pile[v[22]]=P; pile[WZ1]=J; pile[WZ2]=I; 
(*f[1043])( );if(v[102]) goto l2;     /*MODPUI0(P,J,I,V5)*/
V5=pile[WZ3]; 
V39=V5-K;
V49=V39%P;
V50=V49;
...
pile[v[22]]=jvj+20; pile[WZ1]=3681; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3681,246,jvj+21)*/
...
(*f[1560])( );     /*RESTAURE0(R,jvj+18,jvj+17)*/
l8:Q++;
goto l7;
l11:V51=V50+P;
V4=V51;
