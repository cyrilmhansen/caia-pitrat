...
(*f[3875])( );if(v[102]) goto l3;     /*INFB0(jvj+11,jvj+12)*/
...
pile[v[22]]=jvj+21; pile[WZ1]=3874; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3874,246,jvj+22)*/
...
(*f[2058])( );     /*VAUT0(jvj+19,280,jvj+14,V20)*/
