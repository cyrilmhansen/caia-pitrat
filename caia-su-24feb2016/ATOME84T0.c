...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,D,jvj+8)*/
pile[v[22]]=688; pile[WZ1]=jvj+8; 
(*f[1977])( );if(v[102]) goto l2;     /*FNDCND0(688,jvj+8,V6)*/
V6=pile[WZ2]; 
if((V6!=2)) goto l2;
...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,jvj+10,jvj+11)*/
...
(*f[1950])( );if(v[102]) goto l2;     /*FNDOND0(498,jvj+12,jvj+13)*/
if((x[jvj+8]!=x[jvj+13])) goto l2;
pile[v[22]]=489; pile[WZ1]=D; pile[WZ2]=jvj+14; 
(*f[1971])( );     /*FNDEND0(489,D,jvj+14)*/
...
pile[v[22]]=jvj+20; pile[WZ1]=3096; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3096,246,jvj+21)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+10,jvj+17,jvj+16)*/
...
pile[v[22]]=jvj+25; pile[WZ1]=3096; pile[WZ2]=246; pile[WZ3]=jvj+26; 
(*f[189])( );     /*TRI4(jvj+25,3096,246,jvj+26)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+12,jvj+17,jvj+18)*/
x[jvj+14]=t[x[jvj+14]];
goto l1;
}
