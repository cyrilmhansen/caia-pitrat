...
(*f[1499])( );if(v[102]) goto l24;     /*AJUSTECAL0(jvj+18,BA,jvj+19,jvj+20)*/
...
(*f[1708])( );     /*AJUSTECALA0(A,jvj+48,BA,jvj+3,XD)*/
XA=V5;
...
(*f[1499])( );if(v[102]) goto l36;     /*AJUSTECAL0(jvj+51,BA,jvj+52,jvj+53)*/
