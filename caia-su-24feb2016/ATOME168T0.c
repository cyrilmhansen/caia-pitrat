...
(*f[1012])( );     /*PGCD0(V18,K,V12)*/
V12=pile[WZ2]; 
if((V12!=1)) goto l11;
pile[WZ1]=I; pile[WZ2]=K; 
(*f[1043])( );if(v[102]) goto l11;     /*MODPUI0(V18,I,K,V13)*/
V13=pile[WZ3]; 
...
(*f[1591])( );     /*SUBSTITUTION0(jvj+26,jvj+30,jvj+23,jvj+31)*/
...
pile[v[22]]=jvj+41; pile[WZ1]=3740; pile[WZ2]=246; pile[WZ3]=jvj+42; 
(*f[189])( );     /*TRI4(jvj+41,3740,246,jvj+42)*/
...
(*f[1298])( );     /*NOUVCONTR0(jvj+39,jvj+38)*/
goto l11;
l16:V10=134;
goto l4;
}
