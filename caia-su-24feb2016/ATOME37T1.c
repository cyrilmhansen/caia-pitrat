...
(*f[1977])( );if(v[102]) goto l5;     /*FNDCND0(472,N,V3)*/
V3=pile[WZ2]; 
...
(*f[1971])( );     /*FNDEND0(489,jvj+5,jvj+7)*/
for(i=x[jvj+7],V1=0;i>0;i=t[i],V1++)  ;
if((V1!=V3)) goto l2;
pile[v[22]]=365; pile[WZ2]=jvj+8; 
(*f[1971])( );     /*FNDEND0(365,jvj+5,jvj+8)*/
...
pile[v[22]]=jvj+12; pile[WZ1]=3285; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3285,246,jvj+13)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+5,jvj+10,jvj+9)*/
