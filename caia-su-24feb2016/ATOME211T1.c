...
(*f[1950])( );if(v[102]) goto l9;     /*FNDOND0(202,D,jvj+13)*/
...
pile[v[22]]=jvj+16; pile[WZ1]=3502; pile[WZ2]=246; pile[WZ3]=jvj+17; 
(*f[189])( );     /*TRI4(jvj+16,3502,246,jvj+17)*/
...
(*f[1008])( );if(v[102]) goto l3;     /*DECFACTPREM0(V8,jvj+5)*/
