...
pile[v[22]]=280; 
(*f[1977])( );if(v[102]) goto l18;     /*FNDCND0(280,jvj+22,V32)*/
V32=pile[WZ2]; 
if((V32<0)) goto l18;
...
pile[v[22]]=280; 
(*f[1977])( );if(v[102]) goto l30;     /*FNDCND0(280,jvj+61,V94)*/
V94=pile[WZ2]; 
if((V94<0)) goto l30;
...
pile[v[22]]=280; 
(*f[1977])( );if(v[102]) goto l30;     /*FNDCND0(280,jvj+33,V11)*/
V11=pile[WZ2]; 
if((V11<0)) goto l30;
x[jvj+5]=0 ;z[jvj+5]=0;
...
(*f[3898])( );if(v[102]) goto l4;     /*SUPBV0(B,jvj+3,jvj+4)*/
...
(*f[3898])( );if(v[102]) goto l30;     /*SUPBV0(B,jvj+9,jvj+10)*/
...
(*f[3898])( );if(v[102]) goto l12;     /*SUPBV0(B,jvj+12,jvj+13)*/
...
pile[v[22]]=280; 
(*f[1977])( );if(v[102]) goto l18;     /*FNDCND0(280,jvj+20,V37)*/
V37=pile[WZ2]; 
if((V37>=0)) goto l16;
goto l18;
l16:x[R]=x[A] ;z[R]=z[A];
...
pile[v[22]]=164; 
(*f[1977])( );if(v[102]) goto l18;     /*FNDCND0(164,jvj+24,V46)*/
V46=pile[WZ2]; 
...
pile[v[22]]=280; 
(*f[1977])( );if(v[102]) goto l30;     /*FNDCND0(280,jvj+35,V24)*/
V24=pile[WZ2]; 
if((V24<0)) goto l30;
...
(*f[3897])( );if(v[102]) goto l30;     /*INFBV0(B,jvj+36,jvj+37)*/
...
(*f[3897])( );if(v[102]) goto l25;     /*INFBV0(B,jvj+45,jvj+47)*/
...
(*f[3898])( );if(v[102]) goto l27;     /*SUPBV0(B,jvj+45,jvj+50)*/
...
(*f[3898])( );if(v[102]) goto l30;     /*SUPBV0(B,jvj+41,jvj+53)*/
...
(*f[1354])( );     /*POSITIF0(jvj+55,jvj+56)*/
if((x[jvj+56]==135)) goto l29;
goto l30;
l29:pile[v[22]]=B; pile[WZ1]=jvj+55; pile[WZ2]=jvj+57; 
(*f[3898])( );if(v[102]) goto l30;     /*SUPBV0(B,jvj+55,jvj+57)*/
