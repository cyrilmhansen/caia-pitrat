...
(*f[1977])( );if(v[102]) goto l4;     /*FNDCND0(164,D,V3)*/
V3=pile[WZ2]; 
...
(*f[1950])( );if(v[102]) goto l4;     /*FNDOND0(498,D,jvj+6)*/
...
pile[v[22]]=jvj+12; pile[WZ1]=3105; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3105,246,jvj+13)*/
