...
(*f[1120])( );     /*AJE3(jvj+4,jvj+63,107)*/
pile[v[22]]=jvj+57; 
(*f[1120])( );     /*AJE3(jvj+57,jvj+63,107)*/
pile[v[22]]=jvj+51; pile[WZ2]=NNNX; 
(*f[2023])( );     /*REMPLACE0(jvj+51,jvj+63,NNNX)*/
...
(*f[2023])( );     /*REMPLACE0(jvj+5,jvj+27,NNNX)*/
goto l17;
...
(*f[2023])( );     /*REMPLACE0(jvj+28,jvj+50,NNNX)*/
goto l17;
