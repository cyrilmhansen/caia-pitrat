...
x[jvj+3]=0 ;z[jvj+3]=0;
pile[v[22]]=929; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(929,jvj+2,V18)*/
V18=pile[WZ2]; 
...
(*f[1969])( );     /*SETFACTORS0(jvj+10,jvj+11)*/
...
pile[v[22]]=jvj+23; pile[WZ1]=3822; pile[WZ2]=246; pile[WZ3]=jvj+24; 
(*f[189])( );     /*TRI4(jvj+23,3822,246,jvj+24)*/
