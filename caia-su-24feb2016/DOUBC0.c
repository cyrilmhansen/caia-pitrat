...
(*f[1991])( );if(v[102]) goto l3;     /*DOUBX0(jvj+6,jvj+3,jvj+7)*/
...
(*f[1804])( );     /*SUBST1(V46,V47,Y,jvj+20)*/
...
(*f[1993])( );     /*MEMEY0(jvj+16,jvj+6,jvj+34)*/
