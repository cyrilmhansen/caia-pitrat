...
(*f[3189])( );if(v[102]) goto l28;     /*ENTRAINE0(V26,jvj+15,V27,jvj+51,jvj+52)*/
...
pile[v[22]]=jvj+75; pile[WZ1]=3235; pile[WZ2]=246; pile[WZ3]=jvj+76; 
(*f[189])( );     /*TRI4(jvj+75,3235,246,jvj+76)*/
...
(*f[1560])( );     /*RESTAURE0(jvj+46,jvj+57,jvj+58)*/
goto l28;
