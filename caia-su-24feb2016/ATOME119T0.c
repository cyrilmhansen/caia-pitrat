...
(*f[1950])( );if(v[102]) goto l5;     /*FNDOND0(498,jvj+4,jvj+5)*/
...
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(164,D,V10)*/
V10=pile[WZ2]; 
V9=V10-1;
V1=V9;
...
pile[v[22]]=jvj+13; pile[WZ1]=3485; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3485,246,jvj+14)*/
...
(*f[2058])( );     /*VAUT0(jvj+10,164,jvj+11,M)*/
l3:x[jvj+8]=t[x[jvj+8]];
goto l2;
l1:pile[v[22]]=164; pile[WZ1]=D; 
(*f[1977])( );if(v[102]) goto l3;     /*FNDCND0(164,D,V7)*/
V7=pile[WZ2]; 
V1=V7;
goto l4;
