...
pile[v[22]]=jvj+7; 
(*f[3800])( );if(v[102]) goto l8;     /*NEWVAR0(jvj+7)*/
pile[v[22]]=V; pile[WZ1]=jvj+8; 
(*f[1292])( );if(v[102]) goto l8;     /*DEPEXP0(V,jvj+8)*/
...
pile[v[22]]=jvj+32; pile[WZ1]=3799; pile[WZ2]=246; pile[WZ3]=jvj+33; 
(*f[189])( );     /*TRI4(jvj+32,3799,246,jvj+33)*/
