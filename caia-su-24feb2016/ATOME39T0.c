...
(*f[1950])( );if(v[102]) goto l15;     /*FNDOND0(498,DD,jvj+2)*/
pile[v[22]]=473; pile[WZ1]=jvj+2; 
(*f[1977])( );if(v[102]) goto l15;     /*FNDCND0(473,jvj+2,V13)*/
V13=pile[WZ2]; 
if((V13!=1)) goto l15;
pile[v[22]]=509; pile[WZ1]=DD; pile[WZ2]=jvj+13; 
(*f[1971])( );     /*FNDEND0(509,DD,jvj+13)*/
...
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(688,jvj+2,V6)*/
V6=pile[WZ2]; 
if((V6==1)) goto l4;
l1:pile[v[22]]=R; pile[WZ1]=jvj+3; pile[WZ2]=jvj+5; pile[WZ3]=DD; pile[WZ4]=jvj+6; 
(*f[3079])( );if(v[102]) goto l14;     /*EVLM1(R,jvj+3,jvj+5,DD,jvj+6,V1)*/
V1=pile[WZ5]; 
if((V1==134)) goto l4;
...
pile[v[22]]=jvj+20; pile[WZ1]=3078; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3078,246,jvj+21)*/
...
(*f[1571])( );     /*DELIER0(365,jvj+3,jvj+5,jvj+18)*/
goto l14;
...
(*f[1971])( );     /*FNDEND0(509,jvj+3,jvj+16)*/
