...
(*f[1011])( );if(v[102]) goto l4;     /*FVECT0(J,(-2041),V2)*/
V2=pile[WZ2]; 
l4:if((I>=NL)) goto l5;
V16=I-1;
V15=V16*NC;
...
(*f[1011])( );if(v[102]) goto l5;     /*FVECT0(V14,(-1544),V5)*/
V5=pile[WZ2]; 
if((V5!=0)) goto l5;
V10=J-1;
K=1;
...
(*f[1011])( );if(v[102]) goto l2;     /*FVECT0(V11,(-1544),V6)*/
V6=pile[WZ2]; 
if((V6!=0)) goto l5;
l2:K++;
goto l1;
...
(*f[1011])( );if(v[102]) goto l8;     /*FVECT0(V7,(-1544),V2)*/
V2=pile[WZ2]; 
goto l7;
