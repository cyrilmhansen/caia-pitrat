...
x[jvj+3]=0 ;z[jvj+3]=0;
pile[v[22]]=929; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(929,jvj+2,V25)*/
V25=pile[WZ2]; 
...
(*f[3875])( );if(v[102]) goto l5;     /*INFB0(jvj+17,jvj+18)*/
...
pile[v[22]]=jvj+35; pile[WZ1]=3877; pile[WZ2]=246; pile[WZ3]=jvj+36; 
(*f[189])( );     /*TRI4(jvj+35,3877,246,jvj+36)*/
