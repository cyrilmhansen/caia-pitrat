...
(*f[1363])( );     /*VAROBJ0(R,jvj+9)*/
for(i=x[jvj+9],V16=0;i>0;i=t[i],V16++)  ;
if((V16!=2)) goto l8;
x[jvj+5]=0 ;z[jvj+5]=0;
pile[v[22]]=929; pile[WZ1]=jvj+4; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(929,jvj+4,V22)*/
V22=pile[WZ2]; 
...
(*f[1947])( );if(v[102]) goto l8;     /*DEGREE0(R,jvj+10)*/
pile[v[22]]=130; 
...
pile[v[22]]=jvj+35; pile[WZ1]=3842; pile[WZ2]=246; pile[WZ3]=jvj+36; 
(*f[189])( );     /*TRI4(jvj+35,3842,246,jvj+36)*/
