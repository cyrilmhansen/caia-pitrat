...
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(202,D,jvj+2)*/
...
(*f[1971])( );     /*FNDEND0(365,D,jvj+4)*/
for(i=x[jvj+4],V2=0;i>0;i=t[i],V2++)  ;
pile[v[22]]=498; pile[WZ2]=jvj+5; 
(*f[1950])( );if(v[102]) goto l1;     /*FNDOND0(498,D,jvj+5)*/
pile[v[22]]=473; pile[WZ1]=jvj+5; 
(*f[1977])( );if(v[102]) goto l1;     /*FNDCND0(473,jvj+5,V4)*/
V4=pile[WZ2]; 
if((V2>=V4)) goto l1;
...
pile[v[22]]=jvj+8; pile[WZ1]=3495; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3495,246,jvj+9)*/
