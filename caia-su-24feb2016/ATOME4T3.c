...
(*f[3031])( );if(v[102]) goto l1;     /*EXECUTE1(0,S,jvj+9)*/
...
pile[v[22]]=jvj+12; pile[WZ1]=3964; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3964,246,jvj+13)*/
...
(*f[3032])( );     /*NOUVENS0(jvj+10,jvj+9,S)*/
