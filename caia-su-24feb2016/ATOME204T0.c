...
(*f[1950])( );if(v[102]) goto l3;     /*FNDOND0(498,jvj+5,jvj+6)*/
...
(*f[3111])( );if(v[102]) goto l2;     /*INFG0(jvj+12,jvj+10,jvj+13)*/
pile[WZ1]=jvj+11; pile[WZ2]=jvj+14; 
(*f[3110])( );if(v[102]) goto l2;     /*SUPG0(jvj+12,jvj+11,jvj+14)*/
...
pile[v[22]]=jvj+18; pile[WZ1]=3669; pile[WZ2]=246; pile[WZ3]=jvj+19; 
(*f[189])( );     /*TRI4(jvj+18,3669,246,jvj+19)*/
