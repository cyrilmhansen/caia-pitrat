...
(*f[1950])( );if(v[102]) goto l9;     /*FNDOND0(498,D,jvj+9)*/
pile[v[22]]=473; pile[WZ1]=jvj+9; 
(*f[1977])( );if(v[102]) goto l9;     /*FNDCND0(473,jvj+9,V7)*/
V7=pile[WZ2]; 
pile[v[22]]=688; 
(*f[1977])( );if(v[102]) goto l9;     /*FNDCND0(688,jvj+9,V11)*/
V11=pile[WZ2]; 
V8=V9*V11;
pile[v[22]]=473; 
(*f[1977])( );if(v[102]) goto l9;     /*FNDCND0(473,jvj+9,V1)*/
V1=pile[WZ2]; 
pile[v[22]]=688; 
(*f[1977])( );if(v[102]) goto l9;     /*FNDCND0(688,jvj+9,V2)*/
V2=pile[WZ2]; 
x[jvj+7]=0 ;z[jvj+7]=0;
...
pile[v[22]]=jvj+12; pile[WZ1]=3085; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3085,246,jvj+13)*/
