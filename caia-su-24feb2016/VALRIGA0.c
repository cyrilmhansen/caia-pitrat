...
(*f[2040])( );if(v[102]) goto l51;     /*CMLPOS0(jvj+30,V200,jvj+31)*/
V200=pile[WZ1]; 
...
(*f[1007])( );if(v[102]) goto l60;     /*POWER0(V335,V336,V337)*/
V337=pile[WZ2]; 
...
(*f[1007])( );if(v[102]) goto l67;     /*POWER0(V321,V322,V323)*/
V323=pile[WZ2]; 
...
(*f[1007])( );if(v[102]) goto l95;     /*POWER0(V237,V238,V239)*/
V239=pile[WZ2]; 
