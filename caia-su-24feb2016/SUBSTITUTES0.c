...
(*f[1293])( );if(v[102]) goto l1;     /*CONVEXP0(B,jvj+2)*/
...
(*f[1292])( );if(v[102]) goto l3;     /*DEPEXP0(A,jvj+4)*/
...
(*f[1780])( );     /*SUBSTITUTION1(jvj+8,R,jvj+7,jvj+4,jvj+2)*/
...
(*f[1780])( );     /*SUBSTITUTION1(jvj+11,R,jvj+9,jvj+4,jvj+2)*/
x[jvj+14]=t[x[jvj+14]];
goto l12;
}
