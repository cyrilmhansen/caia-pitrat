...
pile[v[22]]=jvj+43; pile[WZ1]=3298; pile[WZ2]=246; pile[WZ3]=jvj+44; 
(*f[189])( );     /*TRI4(jvj+43,3298,246,jvj+44)*/
...
(*f[1740])( );if(v[102]) goto l11;     /*EVLM0(jvj+3,D,jvj+4,V1)*/
V1=pile[WZ3]; 
if((V1!=135)) goto l11;
x[jvj+47]=t[x[jvj+47]];
goto l2;
