...
(*f[1508])( );     /*NATFNS0(V130,jvj+141,BA)*/
if(x[jvj+141]!=1814&&x[jvj+141]!=1050) goto l10;
pile[WZ1]=1917; 
(*f[1508])( );     /*NATFNS0(V130,1917,BA)*/
...
(*f[1508])( );     /*NATFNS0(V252,20,BA)*/
pile[WZ1]=1881; 
(*f[1508])( );     /*NATFNS0(V252,1881,BA)*/
...
(*f[1498])( );     /*TYPEXPR0(jvj+5,BA,jvj+76,jvj+77)*/
pile[v[22]]=V77; pile[WZ1]=jvj+76; pile[WZ2]=BA; 
(*f[1508])( );     /*NATFNS0(V77,jvj+76,BA)*/
pile[WZ1]=jvj+77; 
(*f[1508])( );     /*NATFNS0(V77,jvj+77,BA)*/
if((x[jvj+77]==129)) goto l1;
if((x[jvj+77]==1881)) goto l2;
if((x[jvj+77]!=1917)) goto l3;
pile[WZ1]=1680; 
(*f[1508])( );     /*NATFNS0(V77,1680,BA)*/
goto l3;
...
(*f[1705])( );     /*TYPEXPR1(jvj+3,jvj+4)*/
pile[v[22]]=V54; pile[WZ1]=129; pile[WZ2]=BA; 
(*f[1508])( );     /*NATFNS0(V54,129,BA)*/
pile[WZ1]=jvj+4; 
(*f[1508])( );     /*NATFNS0(V54,jvj+4,BA)*/
pile[WZ1]=1339; 
(*f[1508])( );     /*NATFNS0(V54,1339,BA)*/
l45:RT=68;
pile[v[22]]=jvj+3; pile[WZ1]=BA; pile[WZ2]=278; 
(*f[1495])( );     /*NATFNA0(jvj+3,BA,278)*/
goto l51;
...
(*f[1706])( );     /*MEMEXPR0(V145,W,BA)*/
pile[WZ1]=23; 
(*f[1508])( );     /*NATFNS0(V145,23,BA)*/
...
(*f[1508])( );     /*NATFNS0(V322,jvj+125,BA)*/
pile[v[22]]=V302; pile[WZ1]=jvj+126; 
(*f[1508])( );     /*NATFNS0(V302,jvj+126,BA)*/
...
(*f[1508])( );     /*NATFNS0(V302,jvj+62,BA)*/
l30:pile[v[22]]=BA; pile[WZ1]=V322; pile[WZ2]=jvj+63; 
(*f[1493])( );     /*VDSBA0(BA,V322,jvj+63)*/
...
(*f[1508])( );     /*NATFNS0(V186,1917,BA)*/
pile[v[22]]=V165; 
(*f[1508])( );     /*NATFNS0(V165,1917,BA)*/
pile[v[22]]=BA; pile[WZ1]=V186; pile[WZ2]=jvj+29; 
(*f[1493])( );     /*VDSBA0(BA,V186,jvj+29)*/
...
(*f[1704])( );     /*ANEXP0(V51,jvj+137,BA,jvj+98)*/
...
(*f[1508])( );     /*NATFNS0(V,jvj+133,BA)*/
pile[WZ1]=jvj+135; 
(*f[1508])( );     /*NATFNS0(V,jvj+135,BA)*/
...
(*f[1704])( );     /*ANEXP0(V37,jvj+145,BA,jvj+98)*/
goto l82;
...
(*f[1498])( );     /*TYPEXPR0(jvj+170,BA,jvj+171,jvj+172)*/
pile[v[22]]=V352; pile[WZ1]=jvj+172; pile[WZ2]=BA; 
(*f[1508])( );     /*NATFNS0(V352,jvj+172,BA)*/
pile[WZ1]=jvj+171; 
(*f[1508])( );     /*NATFNS0(V352,jvj+171,BA)*/
goto l98;
}
