...
(*f[3044])( );if(v[102]) goto l10;     /*DIFFERE0(464,N,jvj+16)*/
...
(*f[3031])( );if(v[102]) goto l9;     /*EXECUTE1(V13,jvj+16,jvj+21)*/
E=x[jvj+21];
l3:if((E>0)) goto l4;
...
pile[v[22]]=jvj+30; pile[WZ1]=3043; pile[WZ2]=246; pile[WZ3]=jvj+31; 
(*f[189])( );     /*TRI4(jvj+30,3043,246,jvj+31)*/
...
(*f[3042])( );     /*VOBJ0(jvj+22,202,jvj+8,68)*/
...
pile[v[22]]=jvj+24; pile[WZ1]=3043; pile[WZ2]=246; pile[WZ3]=jvj+25; 
(*f[189])( );     /*TRI4(jvj+24,3043,246,jvj+25)*/
...
(*f[1755])( );     /*LIER1(jvj+7,365,jvj+8,jvj+3)*/
...
pile[v[22]]=jvj+27; pile[WZ1]=3043; pile[WZ2]=246; pile[WZ3]=jvj+28; 
(*f[189])( );     /*TRI4(jvj+27,3043,246,jvj+28)*/
...
(*f[3042])( );     /*VOBJ0(jvj+9,202,jvj+3,68)*/
l5:E=t[E];
goto l3;
l4:LL=s[E];
